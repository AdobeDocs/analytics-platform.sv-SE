...
| Rader per anslutning per år | Varierar efter tilldelat datacenter (mer information finns i beskrivningen) | Prestandagardri | Rekommenderad radgräns per år i en anslutning. De gränser som anges nedan är ungefärliga från och med januari 2026 och kommer att öka med tiden för att tillåta fler rader per anslutning. Om du tror att du kommer att överskrida dessa gränser kontaktar du Adobe kontoteam för att diskutera alternativa konfigurationer. <p>Radgränsen varierar beroende på ditt tilldelade datacenter, enligt följande:</p><ul><li>**USA Azure (standard för amerikanska kunder)**: Ungefär 500 miljarder (cirka 42 miljarder per månad)</li><li>**USA AWS (tillgängligt på begäran för amerikanska kunder)**: Ungefär 30 miljarder (cirka 2,5 miljarder per månad)</li><li>**Amsterdam**: Cirka 200 miljarder (cirka 16,5 miljarder i månaden)</li><li>**Alla andra datacenter**: 25 miljarder (cirka 2 miljarder per månad)</li></ul></p><p>Organisationer väljer sitt datacenter i Experience Platform när de först köper Experience Platform. Detta beslut baseras vanligtvis på datahemvist och krav på hemvist. Alla AEP+Apps-användningsfall (inte bara radvolymer i Customer Journey Analytics) bör beaktas när du väljer ett datacenter.</p><p>Mer information om hur du visar vilket datacenter du har tilldelats finns i [Customer Journey Analytics värdplatser](/help/technotes/data-centers.md)</p> |
