...
| Unika strängar | 10 miljoner - 1 miljard | Systemstyrd Guardrail | Maximalt antal unika nycklar per sökdatamängd. Beroende på Customer Journey Analytics-paketet (se produktbeskrivning).<ul><li>Foundation: 10 miljoner.</li><li>Välj: 100 miljoner.</li><li>Prime: 250 miljoner.</li><li>Ultimate: 1 miljard</li><ul> |
...
| Rader per anslutning per år | Varierar efter tilldelat datacenter (mer information finns i beskrivningen) | Prestandagardri | Radgräns per år i en anslutning. Gränserna nedan gäller från och med den 20 januari 2026 och kan öka med tiden för att tillåta fler rader per anslutning. <p>Radgränsen varierar beroende på ditt tilldelade datacenter, enligt följande:</p><ul><li>**USA Azure (standard för amerikanska kunder)**: Ungefär 500 miljarder (cirka 42 miljarder per månad)</li><li>**USA AWS (tillgängligt på begäran för amerikanska kunder)**: Ungefär 30 miljarder (cirka 2,5 miljarder per månad)</li><li>**Amsterdam**: Cirka 200 miljarder (cirka 16,5 miljarder i månaden)</li><li>**Alla andra datacenter**: 25 miljarder (cirka 2 miljarder per månad)</li></ul><p>Om du förväntar dig att överskrida dessa gränser och vill undvika problem med prestandaförsämringen kontaktar du ditt Adobe-kontoteam för att diskutera alternativa konfigurationer.</p><p>Organisationer kan välja sitt datacenter när de initialt implementerar AEP+Apps. Detta beslut baseras vanligtvis på varje kunds egna krav på dataregistrering. Alla AEP+Apps-användningsfall (inte bara radvolymer i Customer Journey Analytics) bör beaktas när du väljer ett datacenter.</p><p>Mer information om hur du visar vilket datacenter du har tilldelats finns i [Customer Journey Analytics värdplatser](/help/technotes/data-centers.md).</p> |
...
| Beräknade mätvärden | 50 000 | Systemstyrd Guardrail | Maximalt antal beräknade värden för en organisation. |
