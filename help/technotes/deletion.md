...
| Ta bort en datavy i [!UICONTROL Customer Journey Analytics] | När du tar bort en datavy i Customer Journey Analytics fungerar inte längre paneler i ett Workspace-projekt som är beroende av datavyn korrekt. |
