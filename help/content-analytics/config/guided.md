---
title: Content Analytics guidad konfiguration
...
# Content Analytics guidad konfiguration
...
>[!IMPORTANT]
>
>Du kan bara ha en Content Analytics-konfiguration per sandlåda i din organisation.

Så här kommer du åt Content Analytics-konfigurationen
...
| **[!UICONTROL Sandbox]** | Sandlådan inom organisationen där Content Analytics har konfigurerats och implementerats (planeras att konfigureras). |
...
* Välj ![Mer](/help/assets/icons/More.svg) och sedan ![Redigera](/help/assets/icons/Edit.svg) **[!UICONTROL Edit]** för en befintlig Content Analytics-konfiguration. Den här åtgärden öppnar den [guidade konfigurationsguiden](#guided-configuration-wizard).
...
>title="Information"
>abstract="Ange ett namn för anslutningen. I avsnitten **[!UICONTROL Data view]**, **[!UICONTROL Experience capture and definition]** och **[!UICONTROL Data collection]** anger du mer information för att se till att Content Analytics kan konfigureras korrekt."
...
>title="Anslutning"
>abstract="Välj en befintlig anslutning från Customer Journey Analytics som du vill sammanfoga dina Content Analytics-data med."
...
![Konfigurationsinformation för Content Analytics](../assets/aca-configuration-details.png)
...
>title="Datavy"
>abstract="Om du vill konfigurera Content Analytics måste du välja en befintlig datavy. Så att ni kan sammanfoga era Content Analytics-data med andra data."

>[!CONTEXTUALHELP]
>id="aca_onboarding_dataview_header"
>title="Datavy"
>abstract="Välj en befintlig datavy från Customer Journey Analytics som du vill sammanfoga dina Content Analytics-data med."

>[!CONTEXTUALHELP]
>id="aca_onboarding_dataview_header_alt"
>title="Datavy"
>abstract="Välj en befintlig datavy från Customer Journey Analytics som du vill sammanfoga dina Content Analytics-data med.<br/>"

>[!CONTEXTUALHELP]
>id="aca_onboarding_dataview_change_dialog"
>title="Ny datavy"
>abstract="Du har valt en ny datavy för den här konfigurationen. Den nya datavyn kommer att uppdateras med Content Analytics mått och mått. Dessa mått och mått tas bort från den ursprungligen valda datavyn.<br/><br/>Om en annan anslutning är associerad med den nya datavyn uppdateras anslutningen så att den innehåller Content Analytics datamängder. Content Analytics datamängder tas inte bort från den anslutning som ursprungligen valdes."
...
![Content Analytics-konfiguration Experience Capture och definition](../assets/aca-configuration-experience.png)
...
I det här avsnittet konfigurerar du hur du samlar in dina Content Analytics-data.
...
>title="Datainsamling"
>abstract="Ange vilka sidor som ska **inkluderas** eller **exkluderas** vid datainsamling för Content Analytics"
...
>title="Datainsamling"
>abstract="Ange vilka resurser som ska **inkluderas** eller **exkluderas** vid datainsamling för Content Analytics"
...
>title="Datainsamling för webbsidor"
>abstract="**Sidor som ska inkluderas/exkluderas**"
...
>title="Datainsamling för webbresurser"
>abstract="**Assets att inkludera/exkludera**"

>[!CONTEXTUALHELP]
>id="aca_onboarding_datacollection_web_assets_header"
>title="Datainsamling för webbresurser"
>abstract="Ange vilka resurser som ska **inkluderas** eller **exkluderas** när du samlar in data för Content Analytics."

>[!CONTEXTUALHELP]
>id="aca_onboarding_datacollection_mobile_experience_locations_boldheader"
>title="Datainsamling för platser för mobila upplevelser"
>abstract="**Upplevelseplatser som ska uteslutas**"

>[!CONTEXTUALHELP]
>id="aca_onboarding_datacollection_mobile_experience_locations_header"
>title="Datainsamling för platser för mobila upplevelser"
>abstract="Ange vilka upplevelseplatser som ska **exkluderas** när data samlas in för Content Analytics."

>[!CONTEXTUALHELP]
>id="aca_onboarding_datacollection_mobile_asset_locations_boldheader"
>title="Datainsamling för platser för mobila tillgångar"
>abstract="**Resursplatser som ska exkluderas**"

>[!CONTEXTUALHELP]
>id="aca_onboarding_datacollection_mobile_asset_locations_header"
>title="Datainsamling för platser för mobila tillgångar"
>abstract="Ange vilka resursplatser som ska **exkluderas** när du samlar in data för Content Analytics."

>[!CONTEXTUALHELP]
>id="aca_onboarding_datacollection_mobile_asset_urls_boldheader"
>title="Datainsamling för URL:er för mobila resurser"
>abstract="**Resurs-URL:er som ska exkluderas**"

>[!CONTEXTUALHELP]
>id="aca_onboarding_datacollection_mobile_asset_urls_header"
>title="Datainsamling för URL:er för mobila resurser"
>abstract="Ange vilka resurs-URL:er som ska vara **exkluderade** vid datainsamling för Content Analytics."
...
* Så här använder du en befintlig taggegenskap:
  ...
  ![Befintlig tagg för Content Analytics-datainsamling](../assets/aca-configuration-datacollection-existingtag.png)
...
* Ange vilka resurser som ska inkluderas eller exkluderas när du samlar in data för Content Analytics.
  ...
  Ange en sträng för reguljärt uttryck för **[!UICONTROL Assets to include / exclude]**. <br/>Till exempel: `^(?!.*(logo\.jpg)).*$` om du vill exkludera alla JPEG-logotypbilder från Content Analytics.
...
>title="Åsidosättningar av sidhuvud"
>abstract="**Sidhuvud åsidosätter**"

>[!CONTEXTUALHELP]
>id="aca_onboarding_datacollection_header_overrides_header"
>title="Åsidosättningar av sidhuvud"
>abstract="Avancerad funktion för att kringgå robotdetektering eller gatrafik. Content Analytics inkluderar dina anpassade HTTP-huvuden när du anropar slutpunkterna."

Du kan också ange ett rubriknamn och ett hemligt rubrikvärde i avsnittet **[!UICONTROL Header overrides]**.  Denna huvudkonfiguration åsidosätter konfigurationen, vilket garanterar att Content Analytics skickar anpassade HTTP-huvuden för att kringgå eventuella robotdetekterings- eller gatutrafiktekniker som du har implementerat.

![Sidhuvud åsidosätter avsnitt](/help/content-analytics/assets/aca-configuration-header-overrides.png)

1. Aktivera **[!UICONTROL Configure header overrides]**.
1. Ange **[!UICONTROL Header name]**. Exempel: `x-asset-service`.
1. Ange **[!UICONTROL Header value]**. Det du anger är hemligt och inte synligt i användargränssnittet (om du inte uttryckligen väljer att ![visa](/help/assets/icons/Visibility.svg) värdet under indata).
...
* **[!UICONTROL Implement]**: Inställningar för eller ändringar i en konfiguration sparas och implementeras. Alla fält som markerats som ![Obligatoriskt](/help/assets/icons/Required.svg) måste ha korrekta värden. Implementeringen består av följande:
   ...
   * **[!UICONTROL Customer Journey Analytics]**-konfiguration:
      ...
      * En rapportmall från Content Analytics läggs till i Workspace.
   ...
   * **[!UICONTROL Data collection]**-konfiguration:
      * Den nya eller befintliga taggegenskapen är konfigurerad för Content Analytics datainsamling. Den här konfigurationen innebär att tillägget Adobe Content Analytics för taggar tas med.
      * Ett datastream skapas för Content Analytics-händelser.
      * Adobe Content Analytics-tillägget är konfigurerat för att säkerställa att Content Analytics-händelser skickas till Content Analytics datastream.
