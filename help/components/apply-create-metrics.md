...
Välj **[!UICONTROL Components]** > **[!UICONTROL Calculated metrics]**. Detta tar dig till [verktyget för beräknade mätvärden](/help/components/calc-metrics/calc-metr-overview.md), där du kan skapa anpassade mätvärden från befintliga mätvärden.

För att det ska bli enklare att snabbt skapa beräknade mått har **[!UICONTROL Create metric from selection]** lagts till på högerklicksmenyn i frihandstabeller i kolumnen. Det här alternativet visas när en eller flera rubrikkolumnceller är markerade.
