...
* **Beskrivning**: Den beskrivning du vill använda för den här komponenten. Beskrivningen visas när du klickar på ikonen ![i](../assets/i.png) .
* **Taggar**: Använd taggar för att ordna datumintervall. Ett datumintervall kan tillhöra flera taggar.
...
* **Välj förinställning**: Använd den här listrutan om du vill ha ett anpassat datumintervall som baseras på ett intervall som Adobe erbjuder som standard. När du väljer en förinställning kan du anpassa datumintervallet ytterligare efter dina behov. Den påverkar inte förinställningen som Adobe erbjuder.
...
* **När datumet börjar**: Välj om datumet börjar i början av en tidsperiod, i slutet av en tidsperiod eller använd en fast dag.
* **Tidsperioden som ska användas**: Välj hur ofta datumintervallet ska rullas. Du kan få den att rulla varje dag, varje vecka, varje månad, varje kvartal eller varje år.
