...
Mer detaljerad översiktsinformation om intelligenta aviseringar finns i [Översikt över intelligenta aviseringar](/help/components/c-intelligent-alerts/intellligent-alerts.md).

Så här skapar du en varning:

1. Börja skapa en avisering med hjälp av varningsverktyget. I <!-- add this back in after the other methods are available like in AA and make a bulleted list: "You can access the alert builder in any of the following ways:" --> Customer Journey Analytics väljer du **[!UICONTROL Components]** > [!UICONTROL **Varningar**] > **[!UICONTROL Create new alert]**.
