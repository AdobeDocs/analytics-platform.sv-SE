...
>[!NOTE]
>
>Det går bara att använda aviseringar med avvikelseidentifiering (kallas även _Intelligent Alerts_) för organisationer med Customer Journey Analytics Prime- eller Ultimate-paket.
...
Gränssnittet i Alert Builder är bekant för dem som har skapat filter eller beräknade värden i Customer Journey Analytics:
