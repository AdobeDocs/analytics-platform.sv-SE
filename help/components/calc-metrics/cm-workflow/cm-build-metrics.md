...
* I [!DNL Customer Journey Analytics], gå till **[!UICONTROL Components]** > **[!UICONTROL Calculated metrics]** väljer **[!UICONTROL + Add]** högst upp på sidan Beräknade mått.
...
| Lista över Dimensioner | Istället för att lämna verktyget Beräknade mätvärden för att skapa ett enkelt filter (i filterverktyget), t.ex. &quot;Sida = hemsida&quot; kan du dra i sidan och välja Hemsida direkt från verktyget Beräknade mått. Detta ger ett mycket effektivare arbetsflöde för att skapa filtrerade beräknade mätvärden. |
