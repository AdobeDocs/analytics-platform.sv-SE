...
| **[!UICONTROL Title and description]** | Om du vill redigera det beräknade måttet väljer du titellänken, som öppnar verktyget [Beräknade mått](cm-build-metrics.md). Ett delat beräknat mått har indikerats med ![Dela](/help/assets/icons/Share.svg). |
