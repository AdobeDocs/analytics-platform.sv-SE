...
Beräknar en uppskattning av samplingsvariansen med hjälp av formeln (summa(metrisk^2) / (N - 1)) - (summa(metrisk))^2/(N*(N-1)). där N är antalet för den normaliserande behållaren.<br/>Detta används som en del av *valfri tid för giltiga* konfidensberäkningar. I allmänhet är den här funktionen inte användbar ensam, utan kan användas för att kontrollera beräkningar eller för att utföra konfidensberäkningar *manuellt*.
