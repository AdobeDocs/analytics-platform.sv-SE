...
title: Visa komponentinformation
feature: Components
role: User, Admin
...
1. (Valfritt) Markera ikonen **Filter** ![Dataglexikonfilter](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Filter_18_N.svg) och välj sedan något av följande segmentalternativ för att segmentera komponentlistan:
   ...
   | [!UICONTROL **Filter**] | Visa endast komponenter som är filter. (Det här alternativet är också tillgängligt på fliken [!UICONTROL **Snabbsegment**] när du först öppnar datamappningslistan.) <!--this is Filters in Customer Journey Analytics--> |
...
1. Välj den komponent du vill visa i listan med komponenter.
   ...
   | [!UICONTROL **Kontextetikett**] | Det här fältet visas bara om komponentens sammanhangsetikett har uppdaterats i datavyn. <p>Mer information finns i [Komponentinställningar](/help/data-views/component-settings/overview.md). </p> |
   ...
   | [!UICONTROL **Komponenttyp**] | Visar vilken typ av komponent det är, oavsett om det är ett Dimension, mått, filter eller datumintervall. |
