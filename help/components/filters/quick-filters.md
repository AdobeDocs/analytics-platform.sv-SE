...
* Använd bara på projekt som de har skapats i (du kan ändra detta).
...
Användarna behöver behörigheten [!UICONTROL Segment Creation] i [Adobe Admin Console](https://experienceleague.adobe.com/docs/analytics/admin/admin-console/permissions/summary-tables.html?lang=en#analytics-tools) för att kunna skapa snabbfilter.
