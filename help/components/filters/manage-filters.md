...
Du kan [dela](filters-share.md), [segment](filters-filter.md), [tagg](filters-tag.md), [godkänna](filters-approve.md), byta namn på, [kopiera](filters-copy.md), ta bort, exportera segment och markera segment som [favorit](filters-favorite.md) från ett centralt [!UICONTROL Segment]-hanteringsgränssnitt. Så här hanterar du segment:
...
Segmentlistan ➊ alla segment som du äger, de segment som har omfattats av alla dina projekt och de segment som har delats med dig. Listan innehåller följande kolumner:
...
Du kan agera på segment med hjälp av ➋ i åtgärdsfältet. Åtgärdsfältet innehåller följande åtgärder:
