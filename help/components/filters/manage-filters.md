...
description: Lär dig hantera filter i kundreseanalys
...
Gå till Filterhanteraren genom att gå till **[!UICONTROL Customer Journey Analysis]** > **[!UICONTROL Components]** > **[!UICONTROL Filters]** i den övre navigeringen.
...
* Bestäm filteromfånget. Vilken [filterbehållare](/help/components/filters/filters-overview.md) representerar bäst omfånget? Använd den minsta möjliga behållaren.
...
|---|---|
| Kan dela filter med Alla, med Grupper och med Användare. Mer information finns i dokumentationen [till](https://helpx.adobe.com/enterprise/using/manage-products-and-profiles.html) Admin Console. | Kan endast dela filter med enskilda användare. |
