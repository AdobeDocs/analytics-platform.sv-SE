...
Med kundreseanalys kan ni skapa, hantera, dela och tillämpa kraftfulla målgruppsfilter i era rapporter. Med filter kan du identifiera undergrupper av besökare baserat på egenskaper eller webbplatsinteraktioner. Filter är utformade som kodade målgruppsinsikter som du kan bygga för dina specifika behov och sedan verifiera, redigera och dela med andra teammedlemmar.
...
Händelsebehållare innehåller värden som är baserade på en sidindelning:
