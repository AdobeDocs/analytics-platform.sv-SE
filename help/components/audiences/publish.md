...
1. Gör något av följande om du vill skapa och publicera en publik:
   ...
   | --- | --- |
   | Från gränssnittet **[!UICONTROL Published audiences]** | Välj **[!UICONTROL Components]** > **[!UICONTROL Published audiences]** på Customer Journey Analytics huvudmeny. Gränssnittet Publiker visas. Välj **[!UICONTROL Create audience]** så öppnas [!UICONTROL Audience builder]. |
