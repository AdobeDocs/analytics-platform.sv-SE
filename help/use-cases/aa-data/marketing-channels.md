...
* Bearbetningsregler för marknadsföringskanaler måste redan vara konfigurerade. Se [Bearbetningsregler för marknadsföringskanaler](https://experienceleague.adobe.com/sv/docs/analytics/admin/admin-tools/manage-report-suites/edit-report-suite/marketing-channels/c-rules) i guiden för Adobe Analytics-komponenter.
...
2. [Skapa en datavy](/help/data-views/create-dataview.md) som innehåller följande dimensioner:
   * **`channel.typeAtSource`**: Motsvarar dimensionen [Marknadskanal](https://experienceleague.adobe.com/sv/docs/analytics/components/dimensions/marketing-channel).
   * **`channel._id`**: Motsvarar [Marknadskanalinformationen](https://experienceleague.adobe.com/sv/docs/analytics/components/dimensions/marketing-detail)
...
>[!NOTE]
>
>För att maximera effekten av marknadsföringskanaler för attribuering och Customer Journey Analytics finns det [reviderade bästa praxis](https://experienceleague.adobe.com/sv/docs/analytics/components/marketing-channels/mchannel-best-practices).
