---
title: Daglig trend
description: Daglig trendanvändning för BI-tillägg i olika BI-verktyg i Customer Journey Analytics
...
>[!PREREQUISITES]
>
>Kontrollera att du har verifierat en [lyckad anslutning och kan visa och använda datavyer](connect-and-validate.md) för BI-verktyget som du vill testa det här användningsfallet för.
>
