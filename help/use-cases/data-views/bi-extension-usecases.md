...
I den här artikeln beskrivs hur du slutför ett antal användningsfall (15) med Customer Journey Analytics BI-tillägget. I varje exempel förklaras Customer Journey Analytics-funktionaliteten, följt av information om alla BI-verktyg som stöds:
...
* **Anslut**
   * [Visa och koppla data](bi-extension/connect-and-validate.md)

* **Rapportera och analysera**
   * [Daglig trend](bi-extension/daily-trend.md)
   * [Trend varje timme](bi-extension/hourly-trend.md)
   * [Månadstrender](bi-extension/monthly-trend.md)
   * [Enkel dimension rankad](bi-extension/single-dimension-ranked.md)
   * [Flera dimensioner rankade](bi-extension/multiple-dimension-ranked.md)
   * [Räkna distinkta dimensionsvärden](bi-extension/count-distinct-dimension-values.md)
   * [Använd datumintervallnamn för att filtrera](bi-extension/use-date-range-names-to-filter.md)
   * [Använd segmentnamn för att segmentera](bi-extension/use-segment-names-to-segment.md)
   * [Använd dimensionsvärden för att segmentera](bi-extension/use-dimension-values-to-segment.md)
   * [Sortera](bi-extension/sort.md)
   * [Gränser](bi-extension/limits.md)

* **Förstå**

   * [Omformningar](bi-extension/transformations.md)
   * [Visualiseringar](bi-extension/visualizations.md)
...
Power BI Desktop supports the following scenarios for the `FLATTEN` parameter. See [Flatten nested data](https://experienceleague.adobe.com/sv/docs/experience-platform/query/key-concepts/flatten-nested-data) for more information.
...
* [Credentials guide](https://experienceleague.adobe.com/sv/docs/experience-platform/query/ui/credentials)
* [Connect Power BI to Query Service](https://experienceleague.adobe.com/sv/docs/experience-platform/query/clients/power-bi).
...
Tableau Desktop supports the following scenarios for the `FLATTEN` parameter. See [Flatten nested data](https://experienceleague.adobe.com/sv/docs/experience-platform/query/key-concepts/flatten-nested-data) for more information.
...
* [Prerequisites](/help/data-views/bi-extension.md#prerequisites)
* [Credentials guide](https://experienceleague.adobe.com/sv/docs/experience-platform/query/ui/credentials)
* [Connect Tableau Desktop to Query Service](https://experienceleague.adobe.com/sv/docs/experience-platform/query/clients/tableau).
...
Looker supports the following scenarios for the `FLATTEN` parameter. See [Flatten nested data](https://experienceleague.adobe.com/sv/docs/experience-platform/query/key-concepts/flatten-nested-data) for more information.
...
Jupyter Notebook supports the following scenarios for the `FLATTEN` parameter. See [Flatten nested data](https://experienceleague.adobe.com/sv/docs/experience-platform/query/key-concepts/flatten-nested-data) for more information.
...
RStudio supports the following scenarios for the `FLATTEN` parameter. See [Flatten nested data](https://experienceleague.adobe.com/sv/docs/experience-platform/query/key-concepts/flatten-nested-data) for more information.
