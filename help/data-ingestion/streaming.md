...
Se [Skapa en HTTP API-direktuppspelningsanslutning med användargränssnittet](https://experienceleague.adobe.com/docs/experience-platform/sources/ui-tutorials/create/streaming/http.html?lang=en) för en mycket mer omfattande självstudiekurs som förklarar hur du använder autentisering, hur du mappar data när inkommande data inte är kompatibla med ditt XDM-schema och hur du skapar en ny datauppsättning som en del av konfigurationen av direktuppspelningsanslutaren.
