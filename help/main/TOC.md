...
+ Datavyer {#cja-dataviews}
   ...
   + [Sammanhangsmedvetna sessioner](../data-views/context-aware-sessions.md)
...
+ Arbetsyteprojekt {#cja-workspace}
   ...
   + Vanliga frågor om Workspace {#workspace-faq}
      ...
      + [Resultat av trunkerad dimensionspost](../analysis-workspace/workspace-faq/results-truncated.md)
