...
+ Versionsinformation {#releases}
   ...
   + [Förhandsversionsinformation](../release-notes/pre-release-notes.md)
   + [2026 versioner](../release-notes/2026.md)
...
+ Uppgradera och jämför {#compare-aa-cja}
   + Uppgradera till Customer Journey Analytics {#upgrade-to-cja}
      ...
      + [Förbered din organisation](/help/getting-started/cja-upgrade/cja-upgrade-org-readiness.md)
...
+ Dataspegling {#cja-data-mirror}
   ...
   + [Data Mirror snabbstartsguide](/help/data-mirror/relational.md)
...
+ Workspace-projekt {#cja-workspace}
   ...
   + Kuratera och dela {#curate-share}
      ...
      + [Generera bildpresentationer](/help/analysis-workspace/curate-share/generate-slides.md)
   + Exportera {#export}
...
+ Content Analytics {#content-analytics}
   ...
   + Konfiguration {#configuration}
      ...
      + [Fristående konfiguration](/help/content-analytics/config/standalone.md)
...
+ Komponenter {#cja-components}
   ...
   + Realtidsrapportering {#real-time-reporting}
      + [Översikt](/help/components/real-time/real-time.md)
      + [Använd realtidsrapportering](/help/components/real-time/use-real-time.md)
...
+ Stitlar {#stitching}
   ...
   + [Diagrambaserad utjämning](/help/stitching/gbs.md)
   + [Begär sammanfogning](/help/stitching/use-stitching.md)
   + [Aktivera sammanfogning](/help/stitching/use-stitching-ui.md)
...
+ Adobe-integreringar {#integrations}
   ...
   + [Integrera Adobe Advertising](/help/integrations/advertising.md)
...
+ Felsökning {#troubleshooting}
   + [Jämför Source Connector-data](../troubleshooting/compare.md)
