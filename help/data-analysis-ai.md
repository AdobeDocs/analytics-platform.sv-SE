...
**Svar:** Agenten för datainsikter i AI-assistenten samlar in insikter genom att undersöka data i datavyn, inklusive mått och komponenter. Det översätter uppmaningen till rätt dimensioner och mätvärden inom dataområdet.
...
**Svar:** Data Insights-agenten i AI-assistenten förstår på ett intelligent sätt att&quot;region&quot; betyder&quot;kundregion&quot;. Det skapar ett stapeldiagram som bäst visar intäkter per region:
...
**Svar:** Även här väljer Data Insights-agenten i AI-assistenten den lämpligaste visualiseringen, i det här fallet **[!UICONTROL Donut]**-visualiseringen, för att besvara frågan.
...
Granska följande tabell med exempeltermer och fraser som du kan använda i uppmaningar med Data Insights Agent i AI Assistant, tillsammans med de typer av svar du kan förvänta dig.

De här exemplen är utformade för att hjälpa dig att lära dig hur specifika ord eller strukturer kan påverka AI-assistentens resultat och ge dig mer exakta och värdefulla insikter. Agenten för datainsikter i AI-assistenten använder generativ AI, så visualiseringar eller valda data kan variera något mellan liknande uppmaningar.
...
Tänk på följande när du utvärderar ett svar från Data Insights Agent i AI Assistant:
