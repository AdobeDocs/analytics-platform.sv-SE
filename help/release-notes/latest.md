...
| ----------- | ---------- | ------- | ---- |
| **Uppdateringar i användargränssnittet** | [Användningsgränssnittet](/help/connections/manage-connections.md#usage) lägger nu till information om kärndatavolymen och den genomsnittliga radstorleken. | | 4 september 2025 |
...
| **B2B-mallar** | Om du har licens för Customer Journey Analytics B2B edition finns följande ytterligare B2B-mallar nu i Adobe-mallens användargränssnitt: <ul><li>Översikt över B2B-kontoengagemang</li><li>Översikt över B2B-säljprojektsengagemang</li><li>B2B Buying Group Activity</li></ul><p>Mer information finns i [B2B-mallar](/help/analysis-workspace/templates/use-templates.md#b2b-templates) i [Använda mallar](/help/analysis-workspace/templates/use-templates.md).</p> |  | 15 augusti 2025 |
...
| **Skapa mått och mått baserat på användardefinierade kartfält från plattformsschemat** | Användardefinierade kartfält som du definierar i ditt Experience Platform-schema kan nu användas i Customer Journey Analytics.<p>Du kan använda följande kartfält när du skapar mått i Customer Journey Analytics:</p><ul><li>Sträng till sträng</li><li>Sträng till heltal</li></ul><p>Mer information finns i [Komponentinställningar](/help/data-views/component-settings/overview.md).</p><p>Mer information om kartfält i Experience Platform finns i [Definiera kartfält i användargränssnittet](https://experienceleague.adobe.com/sv/docs/experience-platform/xdm/ui/fields/map).</p> |  | Slutet av augusti 2025 |
...
| **Realtidsrapportering** | Realtidsrapportering i Customer Journey Analytics visar och uppdaterar data och visualiseringar inom en eller flera paneler i Analysis Workspace i realtid.<br/><br/>(Dokumentationslänk till flöde.) | | 18 september 2025 (ursprungligen planerat att släppas den 15 augusti 2025) |
