...
| **Härledda fält - Dedupliceringsfunktion** | Funktionen Deduplicera i Härledda fält hjälper dig att förhindra att ett värde räknas flera gånger.<p>[Läs mer](/help/data-views/derived-fields/derived-fields.md#deduplicate)</p> |  | 17 juli 2024 |
