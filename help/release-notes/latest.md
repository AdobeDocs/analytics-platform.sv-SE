...
| ----------- | ---------- | ------- | ---- |
| **Händelsedjupdimension** | En ny händelsdjupdimension läggs till i listan med [standarddimensioner](/help/components/dimensions/overview.md#standard-dimensions) för en datavy. |  | 8 maj 2025 |
