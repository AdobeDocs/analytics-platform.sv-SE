...
| **Härledda fält - Dedupliceringsfunktion** | Funktionen Deduplicera i Härledda fält hjälper dig att förhindra att ett värde räknas flera gånger.<p>(Dokumentationslänk följer)</p> |  | 16 juli 2024 |
