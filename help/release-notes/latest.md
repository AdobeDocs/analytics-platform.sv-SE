...
| **Använd datavyn i Customer Journey Analytics med Adobe Journey Optimizer** | Med ett nytt konfigurationsalternativ i Customer Journey Analytics kan du definiera en datavy för Customer Journey Analytics som ska användas med Adobe Journey Optimizer, utan att behöva konfigurera manuellt. <!-- add this in: <p>For information about how to enable this configuration option, see the [Compatibility](/help/data-views/create-dataview.md#compatibility) section in [Create or edit a data view](/help/data-views/create-dataview.md).</p> --><p>Tidigare var du tvungen att konfigurera en anslutning och datavyer manuellt när du visade Adobe Journey Optimizer-data i Customer Journey Analytics.</p><p>(Dokumentationslänk följer)</p> |  | 19 juni 2024 |
