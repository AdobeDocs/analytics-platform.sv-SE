...
| **Källanslutning för analys: Sök i rapportsviter i Experience Platform** | Kunder med ett stort antal rapportsviter kan nu söka efter den rapportsvit de vill ansluta till i arbetsflödet för dataflödet i Analytics Source Connector. <p>Tidigare var kunderna tvungna att paginera genom en potentiellt lång lista med rapportsviter.</p><p>(Dokumentationslänk som ska följas.) | | 30 oktober 2025 |
