...
| ----------- | ---------- | ------- | ---- |
| **Händelsedjupdimension** | En ny dimension för händelsedjup läggs till i listan med [nödvändiga standardkomponenter](/help/data-views/component-reference.md#required-standard-components) för en datavy. |  | 8 maj 2025 |
| **Ökning av de fullständiga gränserna för tabellexport** | Antalet kolumner som kunder kan använda med fullständig tabellexport ökas från 5 dimensioner och 5 mätvärden till 10 dimensioner och 10 mätvärden. Ökningen gäller alla Customer Journey Analytics-nivåer. Antalet rader som kan exporteras ändras inte. |  | 30 april 2025 |
