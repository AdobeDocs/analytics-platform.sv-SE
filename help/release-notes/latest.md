...
**Senaste uppdatering**: 29 juni 2022

## Viktiga funktioner

| Funktion | Beskrivning | [Måldatum](/help/release-notes/releases.md) |
| ----------- | ---------- | ----- |
| Målgruppspublicering i kundprofil i realtid | Gör att ni kan publicera målgrupper som identifierats i CJA till AEP/RTCDP för kundanpassning och personalisering. [Läs mer](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-components/audiences/audiences-overview.html?lang=en) | Den här funktionen är för närvarande [begränsad testning](/help/release-notes/releases.md). GA är TBD. |
