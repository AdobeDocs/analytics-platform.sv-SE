...
| **Transformation of B2B lookup datasets** | Nu kan du [transformera datauppsättningar för B2B-sökning](/help/connections/transform-datasets-b2b-lookups.md) när du definierar en anslutning. Den här omvandlingen ger stöd för personbaserade sökningar på B2B-data. | | 6 juni 2024 |
...
| **Härledda fält - nya funktioner och funktionsmallar** | Ytterligare härledda fältfunktioner ([Matematik](/help/data-views/derived-fields/derived-fields.md#math), [Nästa eller Föregående](/help/data-views/derived-fields/derived-fields.md#next-or-previous)) och [funktionsmallar](/help/data-views/derived-fields/derived-fields.md#function-templates). | | 5 juni 2024 |
| **Dela konton och platser som används för export och import** | Användarna kan nu göra de konton och platser de skapar tillgängliga för alla användare i organisationen. Endast konto- och platsägare och systemadministratörer kan redigera och ta bort konton och platser.<p>Tidigare kunde konton och platser bara användas av den användare som skapade dem.</p><p>De här inställningarna är tillgängliga när användare konfigurerar molnexportkonton och konfigurerar molnexportplatser.</p> <p>Mer information finns i [Konfigurera molnexportkonton](/help/components/exports/cloud-export-accounts.md) och [Konfigurera platser för molnexport](/help/components/exports/cloud-export-locations.md).</p> | 12 juni 2024 | 30 juni 2024 |
...
| **Ny dokumentation om användningsfall för dataexport** | Den här nya avsnittskonturen [användningsfall vid dataexport](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-usecases/data-export/overview) som<ul><li>Säkerhetskopiering av data</li><li>Dataverifiering</li><li>Data Lake, Data Warehouse eller BI Tools</li><li>Beredskap för AI/ML</li></ul> och implementera dem med Experience Platform och Customer Journey Analytics. | | Ute nu |
