...
| **Använd falldokumentation för Media Edge API:er** | Det finns två nya användningsfall för Media Edge API:er. Det första användningsexemplet beskriver hur du spårar en mediesession som innehåller [två kapitel med annonsbrytning](https://developer.adobe.com/cja-apis/docs/use-cases/media-edge/chapters-with-ad-timeline/). Det andra användningsexemplet beskriver hur du spårar en mediesession som innehåller [ett buffertläge och en paus](https://developer.adobe.com/cja-apis/docs/use-cases/media-edge/buffer-and-pause-timeline/). |  | 13 mars 2024 |
