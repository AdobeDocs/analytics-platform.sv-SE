...
| **Stöd för ad hoc- och relationsscheman** | [Ad hoc](https://experienceleague.adobe.com/sv/docs/experience-platform/xdm/tutorials/ad-hoc) och [relationsscheman](https://experienceleague.adobe.com/sv/docs/experience-platform/xdm/schema/relational) används i arbetsflöden för datainmatning och dataspegling för Experience Platform. |  | 23 september 2025 (ursprungligen planerat att släppas den 28 augusti 2025) |
