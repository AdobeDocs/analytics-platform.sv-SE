...
* [Federerad målgruppssammansättning](https://experienceleague.adobe.com/en/docs/federated-audience-composition/using/release-notes?lang=en)
...
| **Stöd för säkra destinationer i Report Builder** | Nya exportmål har lagts till i Report Builder-tillägget. Följande molnlagringsmål stöds: <ul><li>AEP Data Landing Zone</li><li>Amazon S3 Role ARN</li><li>Google Cloud Platform</li><li>Azure SAS</li><li>Azure RBAC</li></ul> |  | Juni 18,2025 |
