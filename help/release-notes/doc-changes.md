...
| Exempel på källkopplingar | Exempel på källanslutningar som är tillgängliga när du beskriver hur [använda en källkoppling](/help/data-ingestion/sources.md#use-a-source-connector) för datainhämtning. |
| **April 2024** | |
