...
|---|---|
| **Mars 2026** | |
| Dela upp en panel | Dokumentationen runt [släppzonen för en panel](/help/analysis-workspace/c-panels/panels.md#drop-zone) har strukturerats om så att den stöder den nya [break](/help/analysis-workspace/c-panels/panels.md#break-down-a-panel)-funktionen. |
| Technote on Bad IDs (BAVIDs) | Ny [technote på felaktiga ID:n](/help/technotes/badids.md). Tekniken förklarar definitionen av ett felaktigt ID, var i Customer Journey Analytics-gränssnittet felaktiga ID:n används och hur du undersöker data i din anslutning för felaktiga ID:n. |
| Datauppsättningar, förhandsvisa omdesign i anslutningar | Uppdaterad dokumentation för en förbättrad dataförhandsgranskning när du [lägger till](/help/connections/create-connection.md#add-datasets) eller [redigerar](/help/connections/create-connection.md#edit-a-dataset) datauppsättningar i en personbaserad anslutning, inklusive dokumentation om ytterligare [sammanfogningsinformation](/help/stitching/use-stitching-ui.md#datasets-preview) för sammanfogningsaktiverade datauppsättningar. |
| Content Analytics miniatyrbilder och förhandsvisningar | Dokumentation om [miniatyrbilder](/help/content-analytics/report/report.md#thumbnails) och [förhandsvisningar](/help/content-analytics/report/report.md#previews) för ytterligare visualiseringar i Content Analytics. |
| **Februari 2026** | |
| Åsidosättningar av sidhuvud | Dokumentation om ytterligare [header åsidosätter konfigurationen](/help/content-analytics/config/guided.md#header-overrides) för Content Analytics. |
...
| --- | --- |
| **December 2025** | |
| Konsekvenser av sandlådeändringar | Lagt till konsekvenserna av en borttagning eller återställning av en sandlåda i artikeln [Borttagning och återställning](/help/technotes/deletion.md). |
| **November 2025** | |
| Guardrail för rader per dag i en anslutning | [skyddsinformation för dataöverföringsgränser](/help/technotes/guardrails.md) har lagts till om det maximala genomsnittliga antalet rader per dag i en anslutning. |
| **Oktober 2025** | |
| Hantera åtkomst till Data Insights Agent | Behörighetskraven för [och processen för att aktivera datavyer](/help/data-analysis-ai.md#manage-access-to-data-insights-agent) har uppdaterats. |
...
| Importera och använda Experience Platform-målgrupper | Uppdaterad fallartikel om hur du [importerar och använder Experience Platform-målgrupper](/help/use-cases/data-ingestion/ingest-aep-segments.md). |
| Förbered din organisation för uppgradering till Customer Journey Analytics | Lagt till information om hur du [förbereder en organisation för uppgradering till Customer Journey Analytics](/help/getting-started/cja-upgrade/cja-upgrade-org-readiness.md). |
| Rapport om trafik som genererats av LLM och AI | [Använd fallartikel](/help/use-cases/ai-traffic.md) har lagts till om hur du rapporterar LLM- och AI-genererad trafik med härledda fält som grund. Artikeln baseras på bloggartikeln [Spåra och analysera LLM och AI-genererad trafik i Adobe Customer Journey Analytics](https://experienceleaguecommunities.adobe.com/t5/adobe-analytics-blogs/tracking-and-analyzing-llm-and-ai-generated-traffic-in-adobe/ba-p/771967). |
| **September 2025** | |
| Datum före 1900 | En [anteckning](/help/connections/create-connection.md#datasets) har lagts till om hur datum före 1900 hanteras av Customer Journey Analytics. |
| Realtidsrapportering | Lagt till dokumentation om [realtidsrapportering](/help/components/real-time/real-time.md) i Customer Journey Analytics. |
| Användargränssnitt | Dokumentation har lagts till för uppdaterat [användargränssnitt](/help/connections/manage-connections.md#usage) i anslutningar. |
| Stiting Journey Optimizer datasets | [En lista över automatiskt genererade Journey Optimer-datauppsättningar](/help/stitching/overview.md#journey-optimizer-datasets) som kan användas för sammanfogning har dokumenterats. |
| Sammanhangsetiketter | Mer bakgrundsinformation om användning och syfte av [kontextetiketter](/help/data-views/component-settings/overview.md#context-labels) har lagts till i datavykomponenter. |
| **Augusti 2025** | |
| Ny integrering med Adobe Advertising | Lagt till information om [integrering med Adobe Advertising](/help/integrations/advertising.md). |
| Nya härledda fältfunktioner | Dokumentation för de nya härledda fältsfunktionerna: [Date Math](/help/data-views/derived-fields/derived-fields.md#date-math), [Depth](/help/data-views/derived-fields/derived-fields.md#depth) och [Typecast](/help/data-views/derived-fields/derived-fields.md#typecast). |
| **Juli 2025** | |
...
| Alternativ metod för att ge Adobe Azure App åtkomst till din nyckel | Lagt till information om att bevilja behörigheter via auktoriseringsmedgivande när [konfigurerar kundhanterade nycklar](/help/privacy/cmk.md#set-up-customer-managed-keys-for-customer-journey-analytics-on-azure) för Customer Journey Analytics på Azure. |
| **Juni 2025** | |
| Nya kortkommandofunktioner | Med nya kortkommandon i Analysis Workspace kan du nu [flytta Workspace-paneler](/help/analysis-workspace/build-workspace-project/fa-shortcut-keys.md#move-panel-actions) uppåt och nedåt i ett projekt. |
| **Maj 2025** | |
| Customer Journey Analytics [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"} | Utkast till dokumentation om kommande Customer Journey Analytics B2B edition: <ul><li>nya [översikt](/help/getting-started/cja-b2b-edition.md), [koncept och funktioner](/help/getting-started/cja-b2b-concepts-features.md), [snabbstartguide](/help/getting-started/cja-b2b-quick-start-guide.md), [övergångsguide](/help/getting-started/cja-b2b-transition.md) och [användningsexempel](/help/use-cases/b2b/b2b-edition/use-cases-overview.md) artiklar, och</li><li>många uppdateringar av befintlig dokumentation.</li></ul>Dokumentation, artiklar och funktioner för kundresan till B2B edition är märkta med märket [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"} . |
| Validera sammanfogning | Dokumentation har lagts till i [validate](/help/stitching/validate.md) om hur identifiering av sammanslagning påverkar antalet lyckade autentiseringar och den övergripande personidentifieringsprestandan. |
| Händelsens djupdimension | Dokumentation för den nya händelsens djupdimension, som en del av [standarddimensionerna](/help/components/dimensions/overview.md#standard-dimensions) för en datavy. |
| **April 2025** | |
...
| Ny dokumentation om Adobe Product Analytics-funktioner | <ul><li>[Funktionsmatris](/help/guided-analysis/types/funnel.md)</li><li>Förbättrad [lagring](/help/guided-analysis/types/retention.md)</li><li>[Förbättrade insikter i Funnel](/help/guided-analysis/types/funnel.md)</li><li>Jämför händelser i ett enda Funnel-steg</li></ul> |
| **Mars 2024** | |
...
| Lagt till dokumentation om behörighetsförbättringar för Workspace-komponenter som bara är till för projekt | Om du delar ett projekt med andra användare kan dessa användare redigera [snabbsegment](/help/components/segments/seg-quick.md) och andra komponenter som bara är till för projektet och som är inbäddade i det delade projektet. |
| **Februari 2024** | |
...
| Lagt till behörighetskrav för att överföra filer till Azure SAS och Azure RBAC när du konfigurerar platser för molnexport | Exakta behörighetskrav för överföring av filer till Azure SAS och Azure RBAC lades till när [molnexportkonton](/help/components/exports/cloud-export-accounts.md) konfigurerades och [molnexportplatser](/help/components/exports/cloud-export-locations.md) konfigurerades. |
...
| Skyddsräcken | En artikel med en lista över Customer Journey Analytics [skyddsutkast](../technotes/guardrails.md) har lagts till. |
...
| Report Builder-förbättringar | <ul><li>[Filtrera från cell för flera datablock](/help/report-builder/select-data-view.md)</li><li>[Visa och dölj rad- och kolumnrubriker](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-reportbuilder/create-a-data-block.html#build-the-data-block)</li></ul> |
| Edge Network geosökningar | [Datastream-inställningar](https://experienceleague.adobe.com/docs/experience-platform/edge/datastreams/configure.html) visar hur har en geosökningstjänst som tillhandahåller enhetliga geografiska data. |
| **Juni 2023** | |
...
| Dokument om&quot;Välj datavy från cell&quot; i Report Builder | Med den här funktionen kan användare välja datavyn för ett datablock från en cell. [Läs mer](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-reportbuilder/select-data-view.html) |
...
| **April 2023** |  |
| Video om hur du använder segment som dimensioner | Videon om att använda segment som dimension har uppdaterats. <p>Den här videon är länkad från sidan [Skapa segment](/help/components/segments/seg-create.md).</p> <p>Följande är en direktlänk till videon: [Använd segment som dimensioner i Analysis Workspace](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/components/filters/use-filters-as-dimensions.html).</p> |
| Segmentdokumentation | Lagt till artikel om att använda [segmentverktyget](/help/components/segments/seg-builder.md). <p>Effektiv dokumentation i [Skapa segment](/help/components/segments/seg-create.md) och [Segmentöversikt](/help/components/segments/seg-overview.md).</p> |
| Uppdatera till dokumentationen på panelen Experimentation | Ett avsnitt på [tolkade icke-randomiserade dimensioner](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-workspace/panels/experimentation.html#non-randomized) har lagts till. |
| Projektsegment (ad hoc- och snabbsegment) | Effektiv dokumentation om projektsegment och borttagen dubblettinformation. Stegen för att skapa ad hoc-segment kombineras nu med stegen för att [skapa snabbsegment](/help/components/segments/seg-quick.md). |
| **Mars 2023** | |
...
| **Oktober 2022** | |
| Oktober 2022 | Nytt avsnitt om [lösenordsskydd för schemalagda projekt](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-workspace/export/t-schedule-report.html#password). Den här funktionen stöder [HIPAA-beredskap](https://www.adobe.com/trust/compliance/hipaa-ready.html). |
...
| Oktober 2022 | Nytt avsnitt om [Visualisering av nyckelmätvärden](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/visualizations/key-metric.html). |
| Oktober 2022 | Nytt avsnitt om [datum- och datum-tid-funktionalitet i datavyer](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/data-views-usecases.html#date) |
...
| **Augusti 2022** | |
| Augusti 2022 | Adobe Experience Platform-artikel om [Stöd för flera regioner för källkopplingen för Analytics](https://experienceleague.adobe.com/docs/experience-platform/sources/ui-tutorials/create/adobe-applications/analytics.html). |
...
| **Juni 2022** | |
| Juni 2022 | Ny artikel om [AAID, ECID, AACUSTOMID och Analytics-källkopplingen](https://experienceleague.adobe.com/docs/analytics-platform/using/compare-aa-cja/cja-aa-comparison/aaid-ecid-adc.html) |
...
| Juni 2022 | Nytt avsnitt om [stöd för numeriska fält som söknycklar och sökvärden](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/create-connection.html#numeric). |
...
| Maj 2022 | Ny artikel om hur du [hanterar datablock i Customer Journey Analytics Report Builder](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-reportbuilder/manage-reportbuilder.html). |
...
| **April 2022** | |
| April 2022 | Dokumentation om [dimensionsdelsträngar](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/component-settings/substring.html). |
...
| **Februari 2022** | |
| Februari 2022 | En ny guide som riktar sig till administratörer som flyttar från Adobe Analytics till Customer Journey Analytics: [Adobe Analytics till Customer Journey Analytics-utveckling](https://experienceleague.adobe.com/docs/analytics-platform/using/compare-aa-cja/aa-to-cja.html) |
| **Januari 2022** | |
...
| Januari 2022 | Dokumentation om nya funktioner har lagts till för [bindningsdimensioner och mätvärden](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/component-settings/persistence.html#binding-dimension) och för nya [[!UICONTROL First Known]- och [!UICONTROL Last Known] allokeringsinställningar](/help/data-views/component-settings/persistence.md#allocation-settings) |
| Januari 2022 | Ny artikel om att [jämföra dina Adobe Analytics-data med analysdata i Customer Journey Analytics](https://experienceleague.adobe.com/docs/analytics-platform/using/troubleshooting/compare.html) |
...
| Oktober 2021 | Dokumenterade [visualiseringar för kontrollpaneler för analyser](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dashboards/create-scorecard.html#apply-visualizations) |
...
| **September 2021** | |
| September 2021 | [Metrisk borttagning av dubbletter](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/component-settings/metric-deduplication.html) doc |
| September 2021 | [Stöd för sommartid i rapporter](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/create-dataview.html#calendar) |
...
| September 2021 | Dokumentation för [booleska fält](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/component-settings/behavior.html) |
...
| September 2021 | Nytt avsnitt om [effekterna av sammanslagningen av rapportsviter](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/cja-faq.html#6.-Consi-when-merging-report-suites-in-cja) i Customer Journey Analytics. |
| **Augusti 2021** | |
| Augusti 2021 | Nytt avsnitt om den förbättrade [anslutningsfunktionen](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/manage-connections.html) i Customer Journey Analytics. |
| Augusti 2021 | Nytt avsnitt om [skiftlägeskänslighet i datavyns dimensioner](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/create-dataview.html#configure-behavior-settings). |
| **Juni 2021** | |
...
| November 2020 | Innehåll har lagts till i [borttagning av begränsningar för bakgrundsfyllning](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/create-connection.html#backfill-historical-data) för anslutningar. |
