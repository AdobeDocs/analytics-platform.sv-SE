...
|---|---|
| **Februari 2026** | |
| Hantera datavyer | Detaljerad information om hur du [hanterar datavyer](/help/data-views/manage-dataviews.md) har lagts till. |
| Stitlar | Dokumentationen för sammanfogning har uppdaterats för att återspegla de ändringar som är resultatet av [sammanfogningen i gränssnittsfunktionen ](/help/stitching/use-stitching-ui.md) för anslutningar. |
| **Januari 2026** | |
