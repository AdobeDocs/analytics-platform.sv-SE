...
| --- | --- |
| **Januari 2026** | |
| Guardrail för rader per år i en anslutning | [skyddsinformation för dataöverföringsgränser har lagts till](/help/technotes/guardrails.md) om det maximala genomsnittliga antalet rader per år i en anslutning. |
| Visa datacentret där data lagras | [information om datacentren där data lagras har lagts till](/help/technotes/data-centers.md#view-the-data-center-where-your-data-is-stored). |
