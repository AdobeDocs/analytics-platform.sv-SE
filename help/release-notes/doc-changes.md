...
|---|---|
| **Mars 2026** | |
| Technote on Bad IDs (BAVIDs) | Ny teknik på felaktiga ID:n. Tekniken förklarar definitionen av ett felaktigt ID, var i Customer Journey Analytics-gränssnittet felaktiga ID:n används och hur du undersöker data i din anslutning för felaktiga ID:n. |
