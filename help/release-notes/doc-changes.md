...
| --- | --- |
| **Maj 2025** | |
| Händelsens djupdimension | Dokumentation för den nya händelsdjupdimensionen, som en del av de [nödvändiga standardkomponenterna](/help/data-views/component-reference.md#required-standard-components) för en datavy. |
| **April 2025** | |
