...
| Flyttat innehåll om hantering av schemalagda projekt | Skapade en ny artikel i Analytics Components Guide med namnet [Schemalagda projekt](/help/components/scheduled-projects-manager.md). Det här innehållet fanns tidigare i artikeln [Schemalägg projekt](/help/analysis-workspace/curate-share/t-schedule-report.md) i verktygshandboken för analyser. |
...
| April 2021 | Avsnittet [Schemalagda rapporter](/help/analysis-workspace/curate-share/t-schedule-report.md) har lagts till i Workspace. |
