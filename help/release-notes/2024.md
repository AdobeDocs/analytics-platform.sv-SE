...
| **Adobe Product Analytics: Förbättrade insikter i tratt** | I vyn [Funktion](https://experienceleague.adobe.com/en/docs/analytics-platform/using/guided-analysis/funnel/friction) har de skrivna insikterna förbättrats så att de omfattar kategorier, deltas och beskrivningar för att diagrammet och tabellen ska bli mer lättförståeliga. | 17 april 2024 | 26 april 2024 |
| **Adobe Product Analytics: Förbättrad bevarandevy** | Flera funktioner har lagts till i vyn [Retention](https://experienceleague.adobe.com/en/docs/analytics-platform/using/guided-analysis/retention/retention-rates) för att ge djupare och anpassningsbara bevarandeinsikter:<ul><li>Bryt länk för start- och returhändelser</li><li>Jämför flera returhändelser i en enda vy</li><li>Anpassa den kvarhållningsmodell som används med (obegränsat) på eller efter (avgränsat) och inställningarna inom hakparentes</li><li>Visa och dölja enskilda kohortrader i diagrammet</li></ul> | 24 april 2024 | 8 maj 2024 |
| **Adobe Product Analytics: Jämför händelser i ett enskilt tratt-steg** | Du kan nu jämföra händelser i ett enda trattsteg i vyn [Funktion](https://experienceleague.adobe.com/en/docs/analytics-platform/using/guided-analysis/funnel/friction). Detta är särskilt användbart när resan innehåller stegalternativ eller ett steg där ett A/B-experiment utförs. | 23 april 2024 | 3 maj 2024 |
...
| **Upplev Edge-robotidentifiering** | Med [Punktavkänning](https://experienceleague.adobe.com/docs/experience-platform/datastreams/bot-detection.html) kan du identifiera händelser som genererats av Web SDK, Mobile SDK och Server-API som genererade av kända spindlar och bottar. | | 1 maj 2024 |
