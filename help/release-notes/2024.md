...
| Funktion | Beskrivning | [Startar](releases.md) | [Allmän tillgänglighet](releases.md) |
| ----------- | ---------- | ------- | ---- |
| **BI-tillägg** | BI-tillägget ger SQL-åtkomst till de datavyer som du har definierat i Customer Journey Analytics. [Läs mer](https://experienceleague.adobe.com/sv/docs/analytics-platform/using/cja-dataviews/bi-extension) | | 15 maj 2024 |
...
| **Administratörer kan hantera alla platser i sin organisation** | Ett nytt alternativ på sidan [Platser](https://experienceleague.adobe.com/sv/docs/analytics/components/locations/locations-manager) gör att administratörer kan visa och hantera alla platser i organisationen. Tidigare kunde administratörer bara visa och hantera de platser som de skapade. |  | April 2024 |
...
| **Adobe Product Analytics: Förbättrade insikter i Funnel** | I vyn [Funnel](/help/guided-analysis/types/funnel.md) har de skrivna insikterna förbättrats så att de omfattar kategorier, deltas och beskrivningar för att diagrammet och tabellen ska bli mer lättförståeliga. | 17 april 2024 | 26 april 2024 |
...
| **Adobe Product Analytics: Jämför händelser i ett enda Funnel-steg** | Du kan nu jämföra händelser i ett enda funnel-steg i vyn [Funnel](/help/guided-analysis/types/funnel.md). Detta är särskilt användbart när resan innehåller stegalternativ eller ett steg där ett A/B-experiment utförs. | 23 april 2024 | 3 maj 2024 |
...
| **Upplev Edge-robotidentifiering** | Med [Punktavkänning](https://experienceleague.adobe.com/docs/experience-platform/datastreams/bot-detection.html?lang=sv-SE) kan du identifiera händelser som genererats av API:t för Web SDK, Mobile SDK och Server som om de genererats av kända spindlar och bottar. | | 1 maj 2024 |
...
| **Adobe Product Analytics: Jämför händelser i ett enda Funnel-steg** | I vyn Funnel: Funktion kan du nu jämföra händelser i ett enda funnel-steg. Detta är särskilt användbart när resan innehåller stegalternativ eller ett steg där ett A/B-experiment utförs. | 29 mars 2024 | 12 april 2024 |
