...
| **Etablering av guidad analys för Customer Journey Analytics-kunder** | Med hjälp av guidad analys kan användarna själva leverera högkvalitativa data och insikter om kundresan via guidade arbetsflöden som bygger på data från olika kanaler i Customer Journey Analytics. <p>Funktionsövergripande team, från marknadsföring till produkt, kan kommunicera i realtid för att använda och förstå dessa rapporter.</p><p>Upp till 11 guidade analysvyer är nu tillgängliga i Customer Journey Analytics-paket. [Läs mer](https://experienceleague.adobe.com/en/docs/analytics-platform/using/guided-analysis/overview)</p> |  | 17 juli 2024 |
...
| **Inmatningsprioritering och fördröjning** | Du kan nu importera dina händelsedata i Customer Journey Analytics inom 90 minuter (SLT), oavsett om dessa data är 24 timmar, 48 timmar eller 7 dagar gamla. Observera att den här funktionen skiljer sig åt beroende på vilket SKU-paket ditt företag har köpt:<ul><li>Grundläggande om prioriterat intag av Customer Journey Analytics: 24-timmars gamla data inom 90 minuter lång SLT-bearbetning (tillgängligt för Customer Journey Analytics Foundation och Customer Journey Analytics Select)</li><li>Inmatningsmellanliggande Customer Journey Analytics-prioritet: 72-timmars gamla data inom 90 minuters SLT-behandling (tillgängligt för Customer Journey Analytics Prime)</li><li>Avancerad Customer Journey Analytics Prioritet för intag: 1 veckas gamla data inom 90 minuters SLT-bearbetning (tillgängligt för Customer Journey Analytics Ultimate)</li></ul> |  | 12 juni 2024 |
...
| **AI-assistenten för Customer Journey Analytics** | Gör att du kan ställa naturspråkliga frågor i användargränssnittet för Customer Journey Analytics och få svar baserat på dokumentationen för Customer Journey Analytics. <p>(Länk till uppdaterad dokumentation följer)</p> | | 6 juni 2024 |
...
| **Adobe Product Analytics: Jämför händelser i ett enskilt tratt-steg** | Du kan nu jämföra händelser i ett enda trattsteg i vyn [Tratt](/help/guided-analysis/types/funnel.md). Detta är särskilt användbart när resan innehåller stegalternativ eller ett steg där ett A/B-experiment utförs. | 23 april 2024 | 3 maj 2024 |
...
| **Användning av Report Builder ingår i kolumnen Används i i Calculated Metrics Manager och Filters Manager** | När du visar kolumnen **Används i** i Beräknat mått-hanteraren eller Filterhanteraren är användningsdata nu tillgängliga för Report Builder.<p>Tidigare var användningsdata i filterhanteraren bara tillgängliga för aviseringar, projekt, schemalagda projekt och beräknade mätvärden. Användningsdata i hanteraren för beräknade mätvärden var endast tillgängliga för aviseringar, projekt och schemalagda projekt.</p> |  | Juli |
| **Adobe Product Analytics: Jämför händelser i ett enskilt tratt-steg** | I vyn Funnel: Friction kan du nu jämföra händelser i ett enda tratt-steg. Detta är särskilt användbart när resan innehåller stegalternativ eller ett steg där ett A/B-experiment utförs. | 29 mars 2024 | 12 april 2024 |
