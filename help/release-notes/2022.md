...
| **Lösenordsskydd för schemalagda projekt** | Den här funktionen är en del av beredskapen för HIPAA och gäller endast för vårdkunder. [Läs mer](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-workspace/curate-share/t-schedule-report.html?lang=sv-SE#password) | Ej tillämpligt/ | 7 november 2022. |
