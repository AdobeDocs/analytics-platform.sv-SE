...
| **Experimentationspanelen** | Med denna nya Workspace-panel kan Customer Journey Analytics-användare utvärdera hur stort A/B-experiment som helst från alla källor - online, offline, från Adobe-lösningar, Adobe Journey Optimizer och till och med BYO-data är. [Läs mer](/help/analysis-workspace/c-panels/experimentation.md) | 5 oktober 2022 |
...
| **Experimentationspanelen för Customer Journey Analytics** | Med denna nya Workspace-panel kan Customer Journey Analytics-användare utvärdera lyften och förtroendet för alla A/B-experiment från alla källor - online, offline, från Adobe-lösningar, Adobe Journey Optimizer och till och med BYO-data (ta dina egna). [Läs mer](/help/analysis-workspace/c-panels/experimentation.md) | [Begränsad version](/help/release-notes/releases.md) från och med 14 september 2022 |
