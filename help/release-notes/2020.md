...
| Felsökare för Workspace | Workspace Debugger har lagts till på menyn [!UICONTROL Help], vilket ger dig ett smidigare sätt att aktivera den för felsökning av Workspace-begäranden. [Läs mer](https://www.adobe.io/apis/experiencecloud/analytics/docs.html#!AdobeDocs/analytics-2.0-apis/master/reporting-tricks.md) |
