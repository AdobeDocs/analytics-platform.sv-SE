...
| Funktion | [Allmän tillgänglighet](https://experienceleague.adobe.com/docs/analytics/landing/an-releases.html) – Måldatum | Beskrivning |
| -----------| ---------- |-----|
| Stöd för objektarrayer | 18 juni 2020 | CJA-kunder kan nu rapportera dimensioner och mätvärden som visas i objektarrayer i Adobe Experience Platform-scheman för datauppsättningar. [Läs mer](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-usecases/complex-data/object-arrays.html) |
