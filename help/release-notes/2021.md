...
| Customer Journey Analytics API | 18 februari 2021 | Customer Journey Analytics API:er är nu tillgängliga. Med dessa API:er kan du programmässigt redigera komponenter och hämta rapporter. Se [Customer Journey Analytics API-dokumentation](https://www.adobe.io/cja-apis/docs) för mer information. |
