...
description: Versionsinformation 2021 Customer Journey Analytics
...
* Ett problem med utfallsrapporten i Customer Journey Analytics som inte fungerade korrekt har korrigerats. (AN-269761)

## Oktober 2021 {#1021}

| Funktion | Beskrivning | [Allmän tillgänglighet](https://experienceleague.adobe.com/docs/analytics/technotes/releases.html) – Måldatum |
| ----------- | ---------- | ----- |
| Rullande fönster för [!UICONTROL Connection] datalagring | **Obs! Kontakta kundtjänst eller kontoteamet på Adobe om du vill att den här inställningen ska implementeras. Det är ännu inte tillgängligt via användargränssnittet i Customer Journey Analytics.**<p>Här kan du definiera en datalagringsinställning för Customer Journey Analytics som ett rullande fönster i månader (3 månader, 6 månader osv.), vid en [!UICONTROL connection] nivå (inte på [!UICONTROL dataset] nivå). Datalagringen baseras på tidsstämplar för händelsedatamängder och gäller endast för händelsedatamängder. Det finns ingen inställning för datalagring för profil- eller uppslagsdatauppsättningar eftersom det inte finns några tillämpliga tidsstämplar. Den största fördelen är att du bara lagrar eller rapporterar data som är tillämpliga och användbara och tar bort äldre data som inte längre är användbara. Det hjälper er att hålla er inom avtalsgränserna och minskar risken för överlagringskostnader. | 7 oktober 2021 |
...
| Stöd för booleska fält | Customer Journey Analytics har nu stöd för booleska fält. [Läs mer](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/component-settings/behavior.html) | 16 september 2021 |
...
| Funktion | [Allmän tillgänglighet](https://experienceleague.adobe.com/docs/analytics/landing/an-releases.html) – Måldatum | Beskrivning |
| ----------- | ---------- | ----- |
| Stöd för [!UICONTROL Adobe Analytics dashboards] | 25 mars 2021 | [!UICONTROL Customer Journey Analytics] har nu stöd för [!UICONTROL Adobe Analytics dashboards Scorecard Builder] och mobilappen. På så sätt kan chefer och företagsanvändare se sina nyckeltal för olika kanaler baserat på data från Customer Journey Analytics, med samma app som de redan använder för Adobe Analytics. |
...
| CUSTOMER JOURNEY ANALYTICS API | 18 februari 2021 | API:erna för Customer Journey Analytics är nu tillgängliga. Med dessa API:er kan du programmässigt redigera komponenter och hämta rapporter. Se [Customer Journey Analytics API-dokumentation](https://www.adobe.io/cja-apis/docs) för mer information. |
