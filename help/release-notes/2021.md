...
| CUSTOMER JOURNEY ANALYTICS API | 18 februari 2021 | API:erna för Customer Journey Analytics är nu tillgängliga. Med dessa API:er kan du programmässigt redigera komponenter och hämta rapporter. Mer information finns i [Customer Journey Analytics API-dokumentationen](https://www.adobe.io/cja-apis/docs). |
