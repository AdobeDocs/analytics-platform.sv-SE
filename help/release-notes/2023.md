...
| **Kalenderuppdateringar i Workspace** | <ul><li>Datum för ankarpanel: Du kan göra datumintervallets komponenter relativa till panelkalendern. [Läs mer](/help/components/date-ranges/calendar.md)</li><li>Uppdaterade kalenderformat: Kalenderformaten i hela användargränssnittet har uppgraderats för att ge ett mer konsekvent och lättanvänt arbetsflöde.</li><li>Kalenderformeln uppdateras: Om du använder relativa datum återspeglar alla kalenderformler början av panelens datumintervall. [Läs mer](/help/components/date-ranges/calendar.md)</li></ul> | Ej tillämpligt | 8 februari 2023 |
