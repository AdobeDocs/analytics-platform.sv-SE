...
| **Enhetssökningar i Edge Network** | Aktivera automatisk datainsamling av enhetstyper via Experience Platform Edge Network. Den här tjänsten är till stor nytta för Customer Journey Analytics och andra Experience Platform-appar. [Läs mer](https://experienceleague.adobe.com/docs/experience-platform/datastreams/configure.html#geolocation-device-lookup) | Ej tillämpligt | 27 september 2023 |
...
| **Geografiska sökningar i Edge Network** | Du kan använda data för geopositionering i Customer Journey Analytics. Aktivera den här funktionen i datastream-inställningar. [Läs mer](https://experienceleague.adobe.com/docs/experience-platform/datastreams/configure.html#geolocation-network-lookup) |  | 26 juli 2023 |
