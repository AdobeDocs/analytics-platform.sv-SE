...
| **Adobe Product Analytics: Visa/dölj serie** | Klicka på teckenförklaringen eller tabellraderna för att styra hur serierna ska visas i dina visualiseringar.  [Läs mer](https://experienceleague.adobe.com/docs/analytics-platform/using/guided-analysis/overview.html) | Ej tillämpligt | 4 oktober 2023 |
...
| **Edge Network enhetssökningar** | Aktivera automatisk datainsamling av enhetstyper via Experience Platform Edge Network. Den här tjänsten är till stor nytta för Customer Journey Analytics och andra Experience Platform-appar. [Läs mer](https://experienceleague.adobe.com/docs/experience-platform/datastreams/configure.html#geolocation-device-lookup) | Ej tillämpligt | 27 september 2023 |
...
| **Edge Network geo-sökningar** | Du kan använda data för geopositionering i Customer Journey Analytics. Aktivera den här funktionen i datastream-inställningar. [Läs mer](https://experienceleague.adobe.com/docs/experience-platform/datastreams/configure.html#geolocation-network-lookup) |  | 26 juli 2023 |
...
| **Project Manager-sidan är inaktuell** | I och med lanseringen av den nya landningssidan har vi ersatt **[!UICONTROL Project Manager]** som anges under **[!UICONTROL Customer Journey Analytics]** > **[!UICONTROL Components]**. Den nya landningssidan har alla funktioner som finns på den gamla Project Manager-sidan och mycket mer. [Läs mer](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/landing.html#deprecate-pm-page) | Ej tillämpligt | 11 januari 2023 |
