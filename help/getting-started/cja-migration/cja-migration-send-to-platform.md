...
Om du väljer att använda Analytics Source Connector för din migrering behövs ingen mappning eftersom Analytics Source Connector använder samma Adobe Analytics-schema i stället för XDM-schemat.
