...
| <span class="preview">**Steg 2: Välj uppgraderingsväg**</span> | <span class="preview">Det finns olika metoder för uppgradering till Customer Journey Analytics. Välj den metod som är bäst för er organisation, beroende på er nuvarande Adobe Analytics-miljö och era långsiktiga mål.</span> |
...
![cja uppgradering](assets/cja-upgrade-path-chart.png)
...
Innan du använder informationen nedan för att avgöra vilken uppgraderingsväg som är rätt för dig bör du läsa informationen i [Förstå uppgraderingsmöjligheterna](#understand-migration-methods) om du inte redan gjort det.
...
När du har använt informationen ovan för att välja en uppgraderingssökväg ska du lära dig hur [skicka data till Adobe Experience Platform](/help/getting-started/cja-upgrade/cja-upgrade-send-to-platform.md) beroende på vilken uppgraderingsväg du väljer.
