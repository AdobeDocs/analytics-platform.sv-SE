...
| Tar bort en datauppsättning i [!UICONTROL Customer Journey Analytics]? | För närvarande kan du inte ta bort en datauppsättning i en anslutning som har sparats. Du måste ta bort hela anslutningen och börja om från början. (Du kan dock ta bort en datauppsättning i [!UICONTROL Adobe Experience Platform].) |
...
| Tar bort en batch **medan den importeras** till [!UICONTROL Customer Journey Analytics]? | Om det bara finns en batch i datauppsättningen kommer inga data eller delar av data från den gruppen att visas i [!UICONTROL Customer Journey Analytics]. Intag kommer att återställas. Om det till exempel finns 5 batchar i datauppsättningen och 3 av dem redan har importerats när datauppsättningen togs bort, kommer data från dessa tre batchar att visas i [!UICONTROL Customer Journey Analytics]. |
| Tar bort en anslutning i [!UICONTROL Customer Journey Analytics]? | Ett felmeddelande visar att:<ul><li>Datavyer som skapats för den borttagna anslutningen fungerar inte längre.</li><li> Alla arbetsyteprojekt som är beroende av datavyer i den borttagna anslutningen slutar fungera.</li></ul> |
| Tar bort en datavy i [!UICONTROL Customer Journey Analytics]? | Ett felmeddelande visar att alla arbetsyteprojekt som är beroende av den här borttagna datavyn kommer att sluta fungera. |
| Tar bort ett Workspace-projekt i [!UICONTROL Customer Journey Analytics]? | Du kan antingen återskapa projektet eller använda en tillfällig lösning för att återställa projektet. Gå bara till [!UICONTROL > Admin > Logs > Usage and Access Log]söker du efter det borttagna projektet och kopierar dess ID. Öppna sedan ett Workspace-projekt och uppdatera ID:t i URL:en med det kopierade. Spara sedan projektet. |
