...
Den första releasen av Customer Journey Analytics innehåller många av de funktioner som ingår i Analysis Workspace. En fullständig lista finns i [Funktionsstöd för Customer Journey Analytics](cja-aa.md).

## Jämföra CJA med enhetsövergripande analys

[Enhetsövergripande ](https://docs.adobe.com/content/help/en/analytics/components/cda/cda-home.html) analyser kan integreras med Adobe Experience Platform identitetstjänst, antingen med Co-op Graph eller Private Graph, för att identifiera hur digitala enheter kan mappas till människor. Det finns för Adobe Analytics Ultimate-kunder.
