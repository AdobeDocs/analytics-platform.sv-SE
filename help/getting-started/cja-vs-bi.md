...
* **Fungerar som en Headless BI-lösning**: Du definierar mått, mått, filter på ett ställe och sedan kan alla Customer Journey Analytics-klienter (inklusive vårt öppna Customer Journey Analytics API) komma åt de komponenterna. Detta gör att komplexa frågor tas bort från slutanvändarna och garanterar att resultatet blir detsamma, oavsett vilken rapporterings- eller visualiseringsklient du använder.
