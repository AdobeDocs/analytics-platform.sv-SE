...
![Customer Journey Analytics enligt beskrivningen i det här avsnittet](./assets/cjaworkflow.png)
...
* **Kuration och Demokstration**: Följande instrumentpaneler kan skapas i Customer Journey Analytics:
   ...
   * [Delad](/help/analysis-workspace/curate-share/share-projects.md) i olika format, bland annat [PDF](/help/analysis-workspace/export/download-send.md), [CSV](/help/analysis-workspace/export/download-send.md) och via en [dedikerad mobilapp](/help/mobile-app/home.md), till dem som är intresserade av slutrapporterna och/eller visualiseringarna.
