...
I följande tabell visas vilka funktioner som är unika för Customer Journey Analytics och vilka Adobe Analytics som stöds, stöds delvis eller inte stöds i Customer Journey Analytics. De här listorna ändras med tiden när funktioner läggs till i Customer Journey Analytics.
...
| **Dimensioner** | Fullt stöd. Customer Journey Analytics använder XDM och stöder obegränsade dimensioner. Customer Journey Analytics är inte knutet till de egna eVars- eller proffsfunktionerna i traditionella Adobe Analytics. |
...
| **Data Warehouse rapporterar** | [Fullständig tabellexport i Customer Journey Analytics](/help/analysis-workspace/export/export-cloud.md) är utvecklingen av Data Warehouse i Adobe Analytics, med många nya, ofta efterfrågade funktioner som inte är tillgängliga i Datan Warehouse idag. |
...
| **Produktvariabel** | Inom Experience Platform kan användare använda en array med objekt i ett dataset-schema för att tillgodose detta användningsfall. Inom Customer Journey Analytics kan man använda valfritt antal produktvariabler och de är inte begränsade till en enda variabel som i Adobe Analytics. |
