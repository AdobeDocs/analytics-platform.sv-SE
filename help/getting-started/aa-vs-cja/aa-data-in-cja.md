...
1. **Aktivera flerkanalsanalys** vid behov. När du kombinerar flera datauppsättningar i Customer Journey Analytics kan funktionerna för att sammanfoga identiteter i Cross-Channel Analytics hjälpa dig att matcha olika ID-namnutrymmen till ett sammansatt ID för en enda vy av kunden över olika enheter och kanaler. Se [Översikt över flerkanalsanalys](/help/cca/overview.md) för mer information.
