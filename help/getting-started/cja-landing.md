...
>[!TAB Dela upp paneler]

Nu kan du bryta ned en panel i Analysis Workspace. Det finns scenarier där en uppdelning av data och visualiseringar i en panel är att föredra framför att tillämpa segment på en panel.

[![bild](assets/learn-more-button.svg)](/help/analysis-workspace/c-panels/panels.md#break-down-a-panel)

>[!TAB Flera dimensionskolumner]
...
*Du måste ha minst paketet Select för att kunna aktivera sammanfogning.*
...
*Du måste ha Ultimate-paketet för realtidsrapportering.*
...
<table style="table-layout:fixed">
  <tr style="border: 0;">
    ...
    <div><strong>Importera och använd data</strong><br/>Lär dig mer om alternativen som du måste importera data till Experience Platform och använda dem för analys och rapportering.</div>
    </td>
    <td>
    ...
    <div><strong>Content Analytics</strong><br/>Förstå hur innehåll, bredvid beteende, påverkar viktiga resultatindikatorer. Få djupare insikter om kundresedata.</div>
    </td>
  </tr>
  <tr style="border: 0;">
...
<table style="table-layout:fixed">
  ...
  <tr style="border: 0;">
    ...
    <td>
      ...
      <strong>Med mera..</strong><br/><a href="/help/guided-analysis/overview.md">Guidad analys</a> - <a href="/help/content-analytics/content-analytics.md">Content Analytics</a> - <a href="/help/getting-started/cja-b2b-edition.md">B2B edition</a> 
    </td>
  </tr>
</table>
