...
| Uppgift | Detaljer |
| --- | --- |
| **Steg 1: Om du migrerar från Adobe Analytics till Customer Journey Analytics ska du ta reda på vad du ska göra.** | Se [Använda Adobe Analytics rapportsvitsdata i Customer Journey Analytics](/help/getting-started/aa-vs-cja/aa-data-in-cja.md) och [Importera och använda data från traditionella Adobe Analytics](../data-ingestion/analytics.md). |
