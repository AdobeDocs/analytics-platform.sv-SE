...
Om du vill implementera Customer Journey Analytics måste du följa det här arbetsflödet. Some initial tasks are performed in Adobe Experience Platform, and some in Customer Journey Analytics.
