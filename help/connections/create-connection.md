...
>abstract="När du ändrar inställningen för identitetssammanfogning för en datauppsättning påverkas inställningen för person-ID när du tillämpar ändringarna. Om du ändrar Person-ID tas alla befintliga data i anslutningen bort. Du måste importera om data från datauppsättningen baserat på det nya person-ID:t.<br/><br/>När du väljer **[!UICONTROL Continue]** kan rapporteringen fördröjas tills borttagningsprocessen har slutförts."
