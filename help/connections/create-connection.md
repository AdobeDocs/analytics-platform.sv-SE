...
1. Konfigurera anslutningsinställningarna.
   ...
   | **[!UICONTROL Schema]** | The [schema](https://experienceleague.adobe.com/en/docs/experience-platform/xdm/schema/composition) baserat på vilket datauppsättningen skapades i Adobe Experience Platform. |
