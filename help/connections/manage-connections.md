...
description: Lär dig hur du hanterar anslutningar till Experience Platform datauppsättningar i Customer Journey Analytics (Customer Journey Analytics).
mini-toc-levels: 3
...
Om du vill konfigurera vilka kolumner som ska visas i tabellen väljer du ![Kolumninställningar](https://spectrum.adobe.com/static/icons/workflow_18/Smock_ColumnSettings_18_N.svg). Markera de kolumner som ska visas i dialogrutan **[!UICONTROL Customize table]**. Välj sedan **[!UICONTROL Apply]**.

### Sökanslutningar

Du kan snabbt söka efter anslutningar i rutan ![Sök](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Search_18_N.svg).

### Filteranslutningar

Om du vill använda ett filter på listan med anslutningar väljer du ![Filter](/help/assets/icons/Filter.svg). Välj sedan bland följande filteralternativ:
...
| **[!UICONTROL Connection Type]** | Filtrera på **[!UICONTROL person]**-baserade eller **[!UICONTROL account]**-baserade [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}-anslutningar. |
...
| **[!UICONTROL Integrations]** | Endast anslutningar med valda integreringar visas. |
...
| **[!UICONTROL Dataset type]** | Datamängdstypen [](create-connection.md#dataset-types). Typen kan vara **[!UICONTROL Event]**, **[!UICONTROL Profile]**, **[!UICONTROL Lookup]**, **[!UICONTROL Summary]**. En adhoc- eller relationsdatauppsättning identifieras av **[!UICONTROL (Adhoc)]** eller **[!UICONTROL (Relational)]**. Till exempel **[!UICONTROL Event (Adhoc)]** eller **[!UICONTROL Lookup (Relational)]**. |
...
* Panelen **[!UICONTROL Key usage metrics]** som visas:
   ...
   * En staplad lodrät fältvisualisering som visar **[!UICONTROL Core and Historical data reportable rows]** de senaste 13 månaderna.
