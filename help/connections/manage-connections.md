...
### Använda en Journey Optimizer-anslutning i Customer Journey Analytics {#use-connection-in-cja}
...
När du har åtkomst till Customer Journey Analytics måste du tillåta att Journey Optimizer-anslutningen används i Customer Journey Analytics:
...
1. Välj **[!UICONTROL Use in CJA]** i Journey Optimizer-anslutningen.
   ...
   ![Använd i anslutning](assets/use-in-connection.png)
...
#### Ta bort anslutningen från Customer Journey Analytics {#remove-connection-in-cja}

Du kan när som helst ta bort Journey Optimizer-anslutningen från Customer Journey Analytics. Om du tar bort anslutningen från Customer Journey Analytics efter att den har använts får du dock följande resultat:
...
1. Välj **[!UICONTROL Remove from CJA]** när du redigerar en Journey Optimizer-anslutning.
   ...
   ![Använd i anslutning](assets/remove-connection.png)
...
>abstract="Den genomsnittliga storleken på en datarad för den aktuella månaden med en procentuell ändring jämfört med föregående månad."


>[!CONTEXTUALHELP]
>id="connections_coredatavolume"
>title="Kärndatavolym"
>abstract="Den aktuella månadens kärndatavolym. *Behöver bekräftas för den exakta definitionen!*"
