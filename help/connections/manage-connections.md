...
| **[!UICONTROL Dataset type]** | Datamängdstypen [&#128279;](create-connection.md#dataset-types). Typen kan vara **[!UICONTROL Event]**, **[!UICONTROL Profile]**, **[!UICONTROL Lookup]**, **[!UICONTROL Summary]**. En adhoc- eller modellbaserad datauppsättning identifieras av **[!UICONTROL (Adhoc)]** eller **[!UICONTROL (Model)]**. Till exempel **[!UICONTROL Event (Adhoc)]** eller **[!UICONTROL Lookup (Model)]**. |
