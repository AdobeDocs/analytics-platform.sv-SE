...
1. Skapa [icke-förfallande autentiseringsuppgifter i Experience Platform](https://experienceleague.adobe.com/en/docs/experience-platform/query/ui/credentials#non-expiring-credentials). Om du redan vill använda befintliga icke-förfallande autentiseringsuppgifter kontrollerar du att dessa är [migrerade till OAuth](https://experienceleague.adobe.com/en/docs/experience-platform/query/ui/credentials#migrate-credentials).
