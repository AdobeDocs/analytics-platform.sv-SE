...
1. Skapa [icke-förfallande autentiseringsuppgifter i Experience Platform](https://experienceleague.adobe.com/sv/docs/experience-platform/query/ui/credentials#non-expiring-credentials). Om du redan vill använda befintliga icke-förfallande autentiseringsuppgifter kontrollerar du att dessa är [migrerade till OAuth](https://experienceleague.adobe.com/sv/docs/experience-platform/query/ui/credentials#migrate-credentials).

1. Se till att de icke-utgångsdatum som anges är tillgängliga för Customer Journey Analytics-produktprofiler. Du måste vara systemadministratör för att organisationen ska kunna utföra följande steg.
   1. Välj **[!UICONTROL Admin Console]** från ![App](/help/assets/icons/Apps.svg).
   1. Kontrollera att de icke-förfallande autentiseringsuppgifterna läggs till i listan över API-autentiseringsuppgifter.
      1. Välj **[!UICONTROL Users]** på den översta menyn.
      1. Välj **[!UICONTROL API credentials]** i den vänstra listen.
      1. De nya eller migrerade autentiseringsuppgifterna som inte upphör att gälla ska listas och börja med **[!UICONTROL EQS-...]**.

      1. Kontrollera att API-autentiseringsuppgifterna som inte upphör att gälla har åtkomst till Customer Journey Analytics-produkten och -profilerna.

         1. Välj ![ProductDetails](/help/assets/icons/ProductDetails.svg) för API-autentiseringsuppgifterna som inte förfaller **[!UICONTROL EQS-...]**.
         1. I rutan **[!UICONTROL EQS-...]** produktinformation väljer du ![Mer](/help/assets/icons/More.svg) och sedan **[!UICONTROL Edit API credentials]**.
         1. Validera **[!UICONTROL Edit API credentials]** i dialogrutan **[!UICONTROL Assigned profiles]**. Om det inte finns någon Customer Journey Analytics-produkt i listan:
            1. Välj ![Lägg till](/help/assets/icons/Add.svg) och välj **[!UICONTROL Customer Journey Analytics]**.
            1. Välj en eller flera produktprofiler som innehåller de användare som du vill ge åtkomst till för frågetjänsten och BI-tillägget.
            1. Välj **[!UICONTROL Apply]**.

1. Verifiera att du ser API-autentiseringsuppgifter som inte förfaller i Experience Platform Query Service.

   1. Välj **[!UICONTROL Experience Platform]** från ![App](/help/assets/icons/Apps.svg).
   1. Välj **[!UICONTROL Queries]** i den vänstra listen.
   1. Välj **[!UICONTROL Credentials]** på den översta menyn.
   1. Du bör se dina API-autentiseringsuppgifter som inte upphör att gälla, med det namn du angav i steg 1, i listan **[!UICONTROL Non-expiring credentials]**.
