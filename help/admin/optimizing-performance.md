...
Olika faktorer kan påverka både CJA-prestanda och prestanda för ett projekt inom Analysis Workspace. I Workspace kan du få ett felmeddelande som säger &quot;Rapporten är för komplex.&quot; [Är detta den exakta ordalydelsen i meddelandet?] I det här avsnittet diskuteras vilka faktorer som kan leda till det här felet och hur man förenklar rapporten/projektet.
