...
* Om du ska använda [XDM-schemafält (Experience Data Model)](https://experienceleague.adobe.com/sv/docs/experience-platform/xdm/home) för beständigt ID eller person-ID kontrollerar du att identiteterna är korrekt markerade i schemat för händelsedatamängden. [Se Översikt över namnområde för identitet](https://experienceleague.adobe.com/sv/docs/experience-platform/identity/features/namespaces).
