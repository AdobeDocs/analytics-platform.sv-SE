...
Fältbaserad sammanfogning stöder användning av fältgruppen [`identifyMap` ](https://experienceleague.adobe.com/en/docs/experience-platform/xdm/schema/composition#identity) i följande scenarier:
