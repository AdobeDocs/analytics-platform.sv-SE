...
| Krav | Beskrivning |
|--- |--- |
| Produkt-SKU | Du måste ha Adobe Analytics Standard eller Adobe Analytics Premium. Om du bara har tillgång till Rapporter och Analytics som fristående produkt kan du samarbeta med ditt kontoteam för att köpa Adobe Analytics-lösningen. |
| Administratörer | ha full tillgång till Analysis Workspace. |
| Användare | För att kunna aktivera åtkomst till fliken Arbetsyta i Analytics måste administratören skapa en produktprofil med behörigheten Analysis Workspace Access och lägga till användare i den i [Admin Console](https://docs.adobe.com/content/help/en/analytics/admin/admin-console/permissions/product-profile.html). |
