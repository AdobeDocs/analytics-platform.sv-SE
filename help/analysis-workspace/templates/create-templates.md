...
1. I Analysis Workspace väljer du fliken [!UICONTROL **Workspace**] och sedan **[!UICONTROL Templates]** under **[!UICONTROL Adobe templates]** i den vänstra listen.
