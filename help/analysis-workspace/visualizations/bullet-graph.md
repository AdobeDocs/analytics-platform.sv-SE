...
*I den här artikeln beskrivs punktvisualiseringen i **Customer Journey Analytics**. Se [Bullet](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/visualizations/bullet-graph) för **Adobe Analytics**-versionen av den här artikeln.*
