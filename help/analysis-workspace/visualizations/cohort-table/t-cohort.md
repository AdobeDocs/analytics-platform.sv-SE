...
1. (Valfritt) Skapa ett filter eller en målgrupp från en markering.

   Markera celler (angränsande eller icke-angränsande) och högerklicka sedan > **[!UICONTROL Create Filter From Selection]**.

   ![Skapa filter eller målgrupp](assets/retention-createfilter.png)

1. I [filterverktyget](/help/components/filters/filter-builder.md) redigerar du filtret ytterligare och klickar sedan på **[!UICONTROL Save]**.
