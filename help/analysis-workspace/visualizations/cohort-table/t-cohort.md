...
1. I [filterverktyget](/help/components/filters/filter-builder.md) redigerar du segmentet ytterligare och klickar sedan på **[!UICONTROL Save]**.

   Det sparade segmentet kan användas i panelen [!UICONTROL Filter] i [!UICONTROL Analysis Workspace].
