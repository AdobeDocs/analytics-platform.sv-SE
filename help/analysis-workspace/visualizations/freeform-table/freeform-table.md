...
*I den här artikeln visas frihandsritabellens visualisering i **Customer Journey Analytics**.<br/>Se [Frihandstabell](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/visualizations/freeform-table/freeform-table) för **Adobe Analytics**-versionen av den här artikeln.*
