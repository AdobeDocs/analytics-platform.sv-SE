...
Allmänna inställningar gäller för din Customer Journey Analytics-upplevelse i webbläsaren. Mer information om hur du kommer åt dessa inställningar finns i [Redigera inställningar](#edit-preferences).

| Preferens | Alternativ |
| --- | --- |
...
Du kan uppdatera företagsinställningarna som gäller för alla användare och projekt i organisationen. Mer information om hur du kommer åt de här inställningarna finns i [Redigera inställningar](#edit-preferences).
...
| **Projektdelning** | | |
| | Tillåt endast delning med arbetsyteanvändare | När det här alternativet är aktiverat kan användare i din organisation inte se alternativet **[!UICONTROL Share with anyone]** på menyn **[!UICONTROL Share]**. Det innebär att användare inte kan dela projekt med personer som inte har något Analysis Workspace-konto i organisationen enligt beskrivningen i [Dela ett projekt med någon (ingen inloggning krävs)](/help/analysis-workspace/curate-share/share-projects.md#share-public-link) i [Dela projekt](/help/analysis-workspace/curate-share/share-projects.md).<br/>Det här alternativet är inaktiverat som standard för alla organisationer (vilket innebär att användare kan dela projekt med personer utanför organisationen) förutom kunder som har licensierat Healthcare Shield. <p>Tänk på följande när du aktiverar eller inaktiverar det här alternativet:<ul><li>När du aktiverar det här alternativet kan personer som tidigare fått åtkomst till ett projekt via delningsalternativet [!UICONTROL Share with anyone] inte längre komma åt projektet.</li><li>Om det här alternativet är aktiverat (för att endast tillåta delning med Workspace-användare) och sedan inaktiverat (för att tillåta delning med vem som helst), återfår inte personer som tidigare fått åtkomst till ett projekt via delningsalternativet [!UICONTROL Share with anyone] automatiskt sin åtkomst till projektet. I det här fallet måste användaren som delade projektet aktivera alternativet [!UICONTROL **Länken är aktiv**] som är tillgängligt när ett projekt delas med vem som helst **([!UICONTROL Share]** > **[!UICONTROL Share with anyone]**), enligt beskrivningen i [Dela ett projekt med vem som helst (ingen inloggning krävs)](/help/analysis-workspace/curate-share/share-projects.md#share-public-link) i [Dela projekt](/help/analysis-workspace/curate-share/share-projects.md).</li><li>**För kunder som licensierar hälsovård:** Det här alternativet är aktiverat som standard och kan inte inaktiveras. Innan du kan inaktivera detta alternativ så att användare kan använda delningsalternativet [!UICONTROL Share with anyone] måste du först lägga till behörigheten [!UICONTROL Share project links with anyone] (under [!UICONTROL Reporting Tools]) i Adobe Admin Console. När behörigheten har lagts till kan du inaktivera det här alternativet och sedan acceptera det juridiska meddelandet som visas. Mer information om hur du lägger till en behörighet i Admin Console finns i [Hantera produktbehörigheter i Admin Console](https://helpx.adobe.com/enterprise/using/manage-permissions-and-roles.html).</li></ul> |
| | Kräv Experience Cloud-autentisering | När det här alternativet är aktiverat måste de som får åtkomst till ett projekt från alternativet **[!UICONTROL Share with anyone]** i Analysis Workspace autentisera sig med sina inloggningsuppgifter för Experience Cloud.<p>När det här alternativet har aktiverats och en användare delar ett projekt med delningsalternativet [!UICONTROL Share with anyone] aktiveras alternativet [!UICONTROL Require Experience Cloud authentication] i delningsdialogrutan och det kan inte inaktiveras av användaren som delar projektet. Information om hur användare kan dela projekt med vem som helst finns i [Dela ett projekt med vem du vill (ingen inloggning krävs)](/help/analysis-workspace/curate-share/share-projects.md#share-public-link) i [Dela projekt](/help/analysis-workspace/curate-share/share-projects.md). <p> <p>Tänk på följande när du aktiverar det här alternativet: <ul><li>När du aktiverar det här alternativet inaktiveras alla projekt som tidigare delats med delningsalternativet [!UICONTROL Share with anyone] och som inte har alternativet [!UICONTROL Require Experience Cloud authentication] aktiverat.<p>Om det här alternativet aktiveras (för att du ska kunna använda projektautentisering) och sedan inaktiveras (för att alla som har länken ska kunna komma åt Experience Cloud), kommer de som tidigare har fått åtkomst till ett projekt via delningsalternativet [!UICONTROL Share with anyone] inte automatiskt att få åtkomst till projektet igen. I det här fallet måste användaren som delade projektet aktivera alternativet [!UICONTROL Link is active] som är tillgängligt när ett projekt delas med vem som helst **([!UICONTROL Share]** > **[!UICONTROL Share with anyone]** > **[!UICONTROL Link is active]**), enligt beskrivningen i [Dela ett projekt med vem som helst (ingen inloggning krävs)](/help/analysis-workspace/curate-share/share-projects.md#share-public-link) i [Dela projekt](/help/analysis-workspace/curate-share/share-projects.md).</li><li>Det här alternativet är bara tillgängligt om enkel inloggning har implementerats i organisationen. Mer information om hur systemadministratörer kan aktivera SSO för din organisation finns i [Konfigurera identitet och enkel inloggning](https://helpx.adobe.com/enterprise/using/set-up-identity.html).</p><p>Om enkel inloggning har konfigurerats för din organisation kontrollerar du om någon typ av autokontoskapande har implementerats i konsolen. Vanligtvis konfigurerar en systemadministratör detta enligt beskrivningen i [Aktivera automatiskt skapande av konto](https://helpx.adobe.com/enterprise/using/automatic-account-creation.html).</li><li>Om din organisation licensierar hälso- och sjukvårdssköld är det här alternativet aktiverat som standard och kan inte inaktiveras.</li></ul> |
| Projektkommentarer | Tillåt kommentarer i projekt | När det här alternativet är aktiverat finns det ett kommentarsområde till höger om varje projekt i Analysis Workspace. <p>Projektägare kan inaktivera kommentarsområdet för ett visst projekt, enligt beskrivningen i [Skapa projekt](/help/analysis-workspace/build-workspace-project/create-projects.md).</p> <p>Mer information om kommentarer i Analysis Workspace-projekt finns i [Lägga till och hantera kommentarer i projekt](/help/analysis-workspace/build-workspace-project/comment-projects.md).</p> |

{style="table-layout:auto"}

### Inställningar för projekt och analyser {#project-and-analysis-preferences}

>[!CONTEXTUALHELP]
>id="workspace_prefs_categoricalpalette"
>title="Kategoripalett"
>abstract="Gäller många visualiseringar i Analysis Workspace och guidad analys. Varje färg representerar ett distinkt kategorivärde."
...
Du kan anpassa de här inställningarna för alla nya Analysis Workspace-projekt, nya Analysis Workspace-paneler och nya guidade analyser. Mer information om hur du kommer åt dessa inställningar finns i [Redigera inställningar](#edit-preferences).
...
|  | Instansinventering | Aktivera [!UICONTROL Count repeat instances] om du vill ange om upprepade instanser ska räknas i rapporter. När du t.ex. aktiverar det här alternativet behandlas flera på varandra följande sidvyer som flera sidvyer. När det är inaktiverat kan flera sidvisningar i följd på samma sida räknas som en enda sidvy. <p>**Obs!** Den här inställningen påverkar bara vissa mått (t.ex. Sessioner) och gäller inte visualiseringar av flöden eller utfall.</p> |
|  | Nummerformat | <ul><li>1 000,00 (standard)</li><li>1.000,00</li><li>1 000,00</li></ul> |
|  | CSV-avgränsningstecken | <ul><li>Komma (standard)</li><li>Semikolon</li><li>kolon</li><li>rörledning</li><li>Period</li><li>Blanksteg</li><li>Tabb</li></ul> |
...
>abstract="Om du väljer **[!UICONTROL Show anomalies]** körs en anomalitidentifiering automatiskt på den första meterkolumnen som läggs till för en visualisering av en tidsserie i frihandstabellen."
...
Du kan anpassa inställningarna för frihandstabeller för alla nya projekt som du skapar i Analysis Workspace. Mer information om hur du kommer åt de här inställningarna finns i [Redigera inställningar](#edit-preferences).
...
| | Visa prognos | Bestämmer om prognosvärden visas automatiskt för den första meterkolumnen i någon frihandstabell för tidsserier som du skapar. |
| | Tolka noll som inget värde | För celler med värdet 0 anger om en 0-cell eller en tom cell ska visas. Det här är användbart när du tittar på data för varje dag i en månad, och vissa dagar har inte inträffat än.  I stället för att visa 0 för framtida datum kan tomma celler visas i stället. Diagram känner också igen den inställningen (i diagram visas till exempel inte en linje eller stapel med 0 värden när den här inställningen är markerad). |
...
| | Uppdelning efter befattning | Välj det här alternativet om du vill att uppdelningen ska följa placeringen av objektet snarare än själva objektet. Mer information om uppdelningar finns i [Dela upp dimensioner](/help/components/dimensions/t-breakdown-fa.md). |
...
Du kan uppdatera visualiseringsinställningarna för alla nya projekt som du skapar i Analysis Workspace. Mer information om hur du kommer åt de här inställningarna finns i [Redigera inställningar](#edit-preferences).

Vissa av dessa inställningar kan också anpassas för individuella visualiseringar.

Välj de länkade avsnittsrubrikerna om du vill ha mer information om och sammanhanget för de tillgängliga inställningarna.
...
| | Procentandelar | Visar värden i procent för linjevisualiseringar. |
| | Förklaring synlig | Gör att du kan dölja den detaljerade förklaringstexten för linjevisualiseringen. |
| | Begränsa maximalt antal objekt | Minskar antalet objekt på X-axeln i linjevisualiseringen. Den här inställningen kan vara användbar om du har en stor datauppsättning. |
| | Visa dubbelaxel (om tillämpligt) | Gäller endast om du har två mått - du kan ha en y-axel till vänster (för ett mått) och till höger (för det andra måttet). Den här inställningen är till hjälp när ritade mätvärden har mycket olika magnituder. |
| | Normalisering (om tillämpligt) | Tvingar mått till samma proportioner. Den här inställningen är användbar när plottade mätvärden har mycket olika förstoringsgrader. |
| | Visa x-axel | Visar x-axeln i linjediagrammet. |
| | Visa y-axel | Visar y-axeln i linjediagrammet. |
| | Fästpunkt Y-axel | Om alla värden som ritas i diagrammet är betydligt över noll kommer diagrammets standardvärde att återge Y-axelns nedre del icke-noll. Om du markerar den här rutan kommer y-axeln att tvingas till noll (och diagrammet ritas om). |
| | Tillåt avvikelser för att skala Y-axeln | Om du har flera mätvärden i ett diagram måste du hovra över varje avvikelse för att se konfidensintervallet för det måttet. För att göra visualiseringen mer läsbar skalförändras inte Y-axeln automatiskt med konfidensintervallet för avvikelseidentifiering. Med den här inställningen kan konfidensintervallet ändra visualiseringens skala. <p>Mer information finns i [Visa avvikelser i Analysis Workspace](/help/analysis-workspace/c-anomaly-detection/view-anomalies.md).</p> |
| | Tillåt prognos att skala Y-axeln | Om du har prognosvärden som ligger utanför de övre och nedre gränserna för de historiska värdena, skalförändras inte dessa prognosvärden automatiskt med y-axeln. När det här alternativet är aktiverat skalförändras y-axeln korrekt för de prognostiserade värdena. |
...
| | Visa miniatyrdiagram | visa eller dölja linjediagram längst ned i diagrammet. När förklaringen är dold ändras den så att den inte längre refererar visuellt till linjerna. |
| | Visa max och min på miniatyrdiagram | Visa minimi- och maximivärden för primära linjediagram och jämförelseraddiagram. |
| | Visa jämförelse | Visa jämförelsedata. När det är dolt döljs både jämförelsetabellen och de sammanfattande ändringsobjekten. |
| | Alternativ för talvärde | I avsnittet [!UICONTROL **Nyckelmåttsammanfattning**] <ul><li>Visa procentuell ändring</li><li>Visa oformaterad skillnad</li>Rådifferens mellan det totala värdet för måttet i det primära datumintervallet och det sekundära datumintervallet</ul> |
| **[Utfall](/help/analysis-workspace/visualizations/fallout/configuring-fallout.md)** | | |
| | Behållare | Välj önskad behållare för att analysera sökvägen. Den önskade behållaren hjälper dig att förstå kontoengagemang på olika B2B-behållarnivåer [!BADGE B2B Edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}, personligt engagemang på personnivå (över sessioner) eller begränsa analysen till en enda session. <p>Följande alternativ finns:</p> <ul><li>Globala konton [!BADGE B2B-utgåva]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}</li><li>Konton [!BADGE B2B-utgåva]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}</li><li>Buying Groups [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}</li><li>Affärsmöjligheter [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}</li><li>Session</li><li>Person</li></ul> |
| **[Flöde](/help/analysis-workspace/visualizations/c-flow/create-flow.md)** | | |
| | Behållare | Välj önskad behållare att analysera. Den föredragna behållaren hjälper dig att förstå kontointeraktionen på olika B2B-behållarnivåer [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}, personengagemang på personnivå (mellan sessioner) eller begränsa analysen till en enda session. <p>Följande alternativ är tillgängliga:</p> <ul><li>Globala konton [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}</li><li>Konton [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}</li><li>Köpgrupper [!BADGE B2B-utgåva]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}</li><li>Affärsmöjligheter [!BADGE B2B-utgåva]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}</li><li>Session</li><li>Person</li></ul> |
| | Figursätta etiketter | Etiketterna på Flow-elementen trunkeras normalt för att spara skärmutrymme, men du kan göra hela etiketten synlig genom att markera den här rutan. Standard = avmarkerat. |
...
| **Skiktade diagram** | | |
| | 100 % staplad | Den här inställningen för staplade ytor, staplade staplade staplar eller vågräta staplade visualiseringar gör att diagrammet blir en&quot;100 % staplade&quot; visualisering. <p>Mer information finns i [Staplade fält och stolpar](/help/analysis-workspace/visualizations/bar.md).</p> |
| **[Histogram](/help/analysis-workspace/visualizations/histogram.md)** | | |
| | Antal hinkar | Välj antalet datumintervall (hinkar) i visualiseringen. Det maximala antalet undergrupper är 50. <p>Mer information finns i [Histogram](/help/analysis-workspace/visualizations/histogram.md).</p> |
| | Räkningsmetod | Välj bland följande alternativ: <ul><li>Träff</li><li>Session</li><li>Person</li></ul> <p>När det till exempel används med sidvyer kan du välja sidvyer per person, sidvyer för besök eller sidvyer per händelse. För Hit används &quot;Förekomster&quot; som y-axelmått i en friformstabell.</p> |
| **[Sammanfattningsändring](/help/analysis-workspace/visualizations/summary-number-change.md)** | | |
| | Värde | <!-- Seem to be basically the same options as in "Number value options" --> <ul><li>Procentuell ändring</li><li>Oformaterad skillnad</li></ul> |
| | Procentandelar | Visar värden i procent för visualiseringar av sammanfattningsändring. |
