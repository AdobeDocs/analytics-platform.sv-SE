...
| Använd skiftläge | Exempel | Effekt | Analys |
| --- | --- | --- | --- |
| **Förbättra patienternas hälsa** | Jag hade ingen tydlig förståelse för hur många medlemmar i hälsovårdsplanen per vecka som helt enkelt slutade använda den. Vi har nu data som kan fokusera på tillväxt. | **Minska antalet läkarbesök.** Hitta snabbt vilande användare för återengagemang. | [Vyer för aktiv användartillväxt](types/active.md) |
| **Förbättra patientupplevelsen** | Genom att ha direkt insyn i hur många patienter som ringde våra callcenters för att få ett enkelt lösenord förnyade jag min passion att vara laserfokuserad på att minska företagets totala kostnader för att betjäna och stärka vår patientupplevelse. | **Minska den totala kostnaden.** Skapa en bättre patientupplevelse och minska antalet samtal till patientservice. | [Vyn Användningstrender](types/usage.md) <p/><p/> [Bildvy](types/friction.md) |
| **Identifiera upprepade flerkanalsåtgärder efter segment** | Jag behöver förstå hur aktiva medlemmar i Medicare är kvalificerade att använda sina planer för att leverera specifika meddelanden till dem i våra digitala produkter. Produktsignaler hjälper oss att effektivisera marknadsföringen. | **Anpassa registreringsalternativen för Medicare.** Jämför vanliga sekventiella åtgärder med mina mest aktiva planmedlemmar. | [Bildvy](types/friction.md) <p/><p/> [Vyn Aktiv användartillväxt](types/active.md) |
| **Bevara branschens främsta talanger** | Våra analysresurser är så instängda i tid. Jag behöver snabbt få de produktanvändningsdata jag behöver för att ringa mina ledande uppdateringssamtal. | **Minska analytikernas arbetsbörda.** Få svar snabbare. Enkelt att rapportera när jag behöver det som mest. | [Guidad analys](overview.md) |
