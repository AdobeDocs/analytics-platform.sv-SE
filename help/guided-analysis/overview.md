...
1. Dra en visningstyp till Workspace arbetsyta och välj sedan **[!UICONTROL Create *guidad analys *]**för att generera önskad analys (till exempel:**[!UICONTROL Create Trends]**). Du kan också dra en befintlig analys till Workspace Canvas från avsnittet **[!UICONTROL Saved]**.
