---
title: Inslagsvy för första användning
...
* **Avfasade utrullningar**: Eftersom analysen söker efter funktionen första gången i stället för ett fast datum, är den här vyn användbar om du fasar ut utrullningen av dina funktioner över tid.
...
* **[!UICONTROL View]**: Växla mellan den här vytypen och [versionen](release-impact.md).
