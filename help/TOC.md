...
# Hjälp för kundresanalysen {#using}

+ [Produktdokumentation för kundfärgsanalys](getting-started/cja-landing.md)
+ Översikt över kundresanalysen {#cja-overview}
   + [Översikt över kundresanalysen](getting-started/cja-overview.md)
   + [Komma igång](getting-started/cja-getting-started.md)
   + [Vanliga frågor](getting-started/cja-faq.md)
   + [Support för kundens Journey Analytics-funktion](getting-started/cja-aa.md)
...
+ Datavyer {#cja-dataviews}
   ...
   + [Konfigurera datavyer och attribut](data-views/configure-dataviews.md)
+ Arbetsyteprojekt {#cja-workspace}
   ...
   + [Utför avancerad analys](analysis-workspace/perform-adv-analysis.md)
   + Bygga ett Workspace-projekt {#build-workspace-project}
      ...
      + Kolumn- och radinställningar {#column-row-settings}
         ...
         + [Dynamiska kontra statiska artiklar](analysis-workspace/build-workspace-project/column-row-settings/manual-vs-dynamic-rows.md)
   ...
   + Visualiseringar {#visualizations}
      ...
      + Utfall {#fallout}
         ...
         + [Tillämpa filter i utfallsanalys](analysis-workspace/visualizations/fallout/compare-segments-fallout.md)
      + Flöde {#flow}
   ...
   + Paneler {#panels}
      ...
      + [Snabbinsikter, panel](analysis-workspace/c-panels/quickinsight.md)
   ...
   + Attribution IQ {#attribution}
      ...
      + [Attributmodeller och granskningsfönster](analysis-workspace/attribution/models.md)
   ...
   + Vanliga frågor om Workspace {#workspace-faq}
      ...
      + [Tillgänglighet i analysarbetsytan](analysis-workspace/workspace-faq/aw-accessibility.md)
      + [Långsiktigt i Analysis Workspace](analysis-workspace/workspace-faq/long-tail.md)
+ Komponenter {#cja-components}
   ...
   + Beräknade mätvärden {#cja-calcmetrics}
      + [Översikt över beräknade mått](components/calc-metrics/calc-metr-overview.md)
      + [Skapa ett beräknat mått](components/calc-metrics/create.md)
      + [Hantera beräknade mått](components/calc-metrics/manage.md)
      + [Grundläggande funktioner](components/calc-metrics/cm-functions.md)
      + [Avancerade funktioner](components/calc-metrics/cm-adv-functions.md)
   + Datumintervall {cja-datumintervall}
      ...
      + [Kalenderöversikt](components/date-ranges/calendar.md)
...
+ Använd fall {#cja-usecases}
   + [Användningsfall för kundresanalysen](use-cases/cja-usecases.md)
   + [Använda arrayer med objekt](use-cases/object-arrays.md)
   + [(B2B) Lägg till kontonivådata som en uppslagsuppdatamängd](use-cases/b2b.md)
